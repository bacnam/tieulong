...
/* 47 */     for (; this.fPrefix < end && 
/* 48 */       this.fExpected.charAt(this.fPrefix) == this.fActual.charAt(this.fPrefix); this.fPrefix++);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 57 */     while (actualSuffix >= this.fPrefix && expectedSuffix >= this.fPrefix && 
/* 58 */       this.fExpected.charAt(expectedSuffix) == this.fActual.charAt(actualSuffix)) {
/*    */       actualSuffix--;
/*    */       expectedSuffix--;
/*    */     } 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/junit/framework/ComparisonCompactor.class
