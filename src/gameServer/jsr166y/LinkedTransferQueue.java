...
return null;  Node n;
if ((n = p.next) != null) {
Node u; p = (p != t && t != (u = this.tail)) ? (t = u) : ((p != n) ? n : null); continue;
} 
if (!p.casNext(null, s)) {
p = p.next; continue;
}  break;
...
randomYields = ThreadLocalRandom.current();  continue;
} 
if (spins > 0) {
spins--;
...
if (p == s) {
p = this.head; continue;
}  if (!s.isMatched()) {
p = s; continue;
}  Node n; if ((n = s.next) == null) {
break;
}
p.casNext(s, n);
} 
