...
/*     */   
/*  33 */   public DungeonFeature(Player player) { super(player);
/*     */ 
/*     */ 
/*     */ 
/*     */     
/*  38 */     this.dungeonRebirth = Maps.newConcurrentHashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 121 */     this.begintime = 0;
/* 122 */     this.reward = null; }
...
/* 125 */         this.incdRecords.poll();  }  return rtn; } public void beginFight(Reward reward) { this.begintime = CommTime.nowSecond();
/* 126 */     this.reward = reward; }
