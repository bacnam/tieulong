...
Map<PrizeType, IItemFilter<?>> map = new HashMap<>(); byte b; int i; IItemFilter[] arrayOfIItemFilter;
for (i = (arrayOfIItemFilter = filter).length, b = 0; b < i; ) { IItemFilter<?> f = arrayOfIItemFilter[b];
map.put(f.getType(), f); b++; }
