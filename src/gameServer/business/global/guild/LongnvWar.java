...
((List<LongnvwarpuppetBO>)this.puppets.get(Long.valueOf(puppet.getPid()))).add(puppet); continue;
} 
...
((List<LongnvResultBO>)map.get(Long.valueOf(bo.getDefpid()))).add(bo); continue;
} 
