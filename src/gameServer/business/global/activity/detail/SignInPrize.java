...
return ActivityType.SignInPrize;
}
...
if (bo.getExtInt(0) >= RefSignIn.SignInPrizeMaxDay) {
return;
}
bo.setExtInt(1, 0);
bo.saveAll();
player.pushProto("signInPrizeRefresh", dailySignProto(player));
} catch (Exception e) {
...
return SignInType.SignInPrize.ordinal() * 1000 + signInCount;
}
