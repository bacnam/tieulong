...
/*    */   
/*    */   public void onEnd() {
/* 30 */     for (Record record : RankManager.getInstance().getRankList(RankType.TianLongPower, RankManager.getInstance().getRankSize(RankType.TianLongPower))) {
/* 31 */       if (record == null)
/*    */         continue; 
/* 33 */       int rank = record.getRank();
/* 34 */       for (RefOpenServerRankReward ref : RefOpenServerRankReward.RankRewardByType.get(ConstEnum.RankRewardType.TianLongRank)) {
...
/* 45 */     return ActivityType.TianLongRank;
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/business/global/activity/detail/RankTianLong.class
