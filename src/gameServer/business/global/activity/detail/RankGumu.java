...
/*    */   
/*    */   public void onEnd() {
/* 30 */     for (Record record : RankManager.getInstance().getRankList(RankType.GuMuPower, RankManager.getInstance().getRankSize(RankType.GuMuPower))) {
/* 31 */       if (record == null)
/*    */         continue; 
/* 33 */       int rank = record.getRank();
/* 34 */       for (RefOpenServerRankReward ref : RefOpenServerRankReward.RankRewardByType.get(ConstEnum.RankRewardType.GumuRank)) {
...
/* 45 */     return ActivityType.GumuRank;
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/business/global/activity/detail/RankGumu.class
