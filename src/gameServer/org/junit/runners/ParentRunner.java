...
/*     */ {
/*  60 */   private static final List<TestClassValidator> VALIDATORS = Arrays.asList(new TestClassValidator[] { (TestClassValidator)new AnnotationsValidator(), (TestClassValidator)new PublicClassValidator() });
/*     */ 
/*     */   
...
/* 125 */     validatePublicVoidNoArgMethods((Class)BeforeClass.class, true, errors);
/* 126 */     validatePublicVoidNoArgMethods((Class)AfterClass.class, true, errors);
...
/*     */     
/* 216 */     return befores.isEmpty() ? statement : (Statement)new RunBefores(statement, befores, null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 230 */     return afters.isEmpty() ? statement : (Statement)new RunAfters(statement, afters, null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 245 */     return classRules.isEmpty() ? statement : (Statement)new RunRules(statement, classRules, getDescription());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     try {
/* 287 */       for (T each : getFilteredChildren()) {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/junit/runners/ParentRunner.class
