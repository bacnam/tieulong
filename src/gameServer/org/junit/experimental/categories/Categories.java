...
/* 322 */     IncludeCategory annotation = klass.<IncludeCategory>getAnnotation(IncludeCategory.class);
/* 323 */     return createSet((annotation == null) ? null : annotation.value());
/*     */   }
/*     */   
/*     */   private static boolean isAnyIncluded(Class<?> klass) {
/* 327 */     IncludeCategory annotation = klass.<IncludeCategory>getAnnotation(IncludeCategory.class);
/* 328 */     return (annotation == null || annotation.matchAny());
/*     */   }
/*     */   
/*     */   private static Set<Class<?>> getExcludedCategory(Class<?> klass) {
/* 332 */     ExcludeCategory annotation = klass.<ExcludeCategory>getAnnotation(ExcludeCategory.class);
/* 333 */     return createSet((annotation == null) ? null : annotation.value());
/*     */   }
/*     */   
/*     */   private static boolean isAnyExcluded(Class<?> klass) {
/* 337 */     ExcludeCategory annotation = klass.<ExcludeCategory>getAnnotation(ExcludeCategory.class);
...
/* 379 */     Set<Class<?>> set = new HashSet<Class<?>>();
/* 380 */     if (t != null) {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/junit/experimental/categories/Categories.class
