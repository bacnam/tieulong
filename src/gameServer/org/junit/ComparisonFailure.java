...
/*     */       }
/*  99 */       DiffExtractor extractor = new DiffExtractor();
...
/*     */       
/* 122 */       for (; suffixLength <= maxSuffixLength && 
/* 123 */         this.expected.charAt(this.expected.length() - 1 - suffixLength) == this.actual.charAt(this.actual.length() - 1 - suffixLength); suffixLength++);
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/*     */     {
/* 139 */       private final String sharedPrefix = ComparisonFailure.ComparisonCompactor.this.sharedPrefix();
/* 140 */       private final String sharedSuffix = ComparisonFailure.ComparisonCompactor.this.sharedSuffix(this.sharedPrefix);
/*     */ 
/*     */       
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/junit/ComparisonFailure.class
