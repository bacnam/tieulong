...
/*    */     
/* 37 */     List<Method> methods = this.testClass.getAnnotatedMethods((Class)Test.class);
...
/* 44 */     validateTestMethods((Class)BeforeClass.class, true);
/* 45 */     validateTestMethods((Class)AfterClass.class, true);
/*    */   }
/*    */   
...
/*    */       }
/*    */       
/* 87 */       if (each.getReturnType() != void.class) {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/junit/internal/runners/MethodValidator.class
