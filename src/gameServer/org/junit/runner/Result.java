...
/* 114 */       Result.this.startTime.set(System.currentTimeMillis());
/*     */     }
/*     */     private Listener() {}
/*     */     
...
/* 173 */       this.fCount = (AtomicInteger)fields.get("fCount", (Object)null);
/* 174 */       this.fIgnoreCount = (AtomicInteger)fields.get("fIgnoreCount", (Object)null);
/* 175 */       this.fFailures = (List<Failure>)fields.get("fFailures", (Object)null);
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/junit/runner/Result.class
