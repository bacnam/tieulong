...
/* 1062 */     Object result = AccessController.doPrivileged(new PrivilegedAction(factoryClass, classLoader) { private final String val$factoryClass;
/*      */           
/*      */           public Object run() {
...
/* 1355 */     return AccessController.<InputStream>doPrivileged(new PrivilegedAction(loader, name) { private final ClassLoader val$loader; private final String val$name;
/*      */           
/*      */           public Object run() {
...
/* 1383 */     PrivilegedAction action = new PrivilegedAction(loader, name) { private final ClassLoader val$loader; private final String val$name;
/*      */         
/*      */         public Object run() {
/*      */           try {
...
/* 1420 */     PrivilegedAction action = new PrivilegedAction(url) { private final URL val$url;
/*      */         
/*      */         public Object run() {
/*      */           try {
...
/* 1510 */             propsUrl = url;
/* 1511 */             props = newProps;
/* 1512 */             priority = newPriority; continue;
/*      */           } 
...
/* 1558 */     return AccessController.<String>doPrivileged(new PrivilegedAction(key, def) { private final String val$key; private final String val$def;
/*      */           
/*      */           public Object run() {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/apache/commons/logging/LogFactory.class
