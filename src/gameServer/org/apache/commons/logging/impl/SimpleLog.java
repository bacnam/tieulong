...
/*     */     
/* 290 */     if (showDateTime) {
/* 291 */       String dateText; Date now = new Date();
/*     */       
...
/* 303 */       case 2: buf.append("[DEBUG] "); break;
/* 304 */       case 3: buf.append("[INFO] "); break;
/* 305 */       case 4: buf.append("[WARN] "); break;
/* 306 */       case 5: buf.append("[ERROR] "); break;
/* 307 */       case 6: buf.append("[FATAL] ");
/*     */         break; }
/*     */ 
/*     */     
...
/* 707 */     return AccessController.<InputStream>doPrivileged(new PrivilegedAction(name) { private final String val$name;
/*     */           
/*     */           public Object run() {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/apache/commons/logging/impl/SimpleLog.class
