...
/*  683 */     return AccessController.<String>doPrivileged(new PrivilegedAction(key, def) { private final String val$key;
/*      */           
/*      */           public Object run() {
...
/*      */     try {
/*  700 */       return AccessController.<ClassLoader>doPrivileged(new PrivilegedAction(this, cl) { private final ClassLoader val$cl;
/*      */             
/*      */             public Object run() {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/apache/commons/logging/impl/LogFactoryImpl.class
