...
/*     */     } 
/* 142 */     if ("Set-Cookie2".equals(header.getName())) {
/* 143 */       return this.strict.parse(helems, origin);
/*     */     }
/* 145 */     return this.obsoleteStrict.parse(helems, origin);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 157 */       if (cookie instanceof org.apache.http.cookie.SetCookie2) {
/* 158 */         this.strict.validate(cookie, origin);
/*     */       } else {
/* 160 */         this.obsoleteStrict.validate(cookie, origin);
/*     */       } 
/*     */     } else {
/* 163 */       this.netscapeDraft.validate(cookie, origin);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 172 */       if (cookie instanceof org.apache.http.cookie.SetCookie2) {
/* 173 */         return this.strict.match(cookie, origin);
/*     */       }
/* 175 */       return this.obsoleteStrict.match(cookie, origin);
/*     */     } 
/*     */     
/* 178 */     return this.netscapeDraft.match(cookie, origin);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 188 */       if (!(cookie instanceof org.apache.http.cookie.SetCookie2)) {
...
/* 195 */     if (version > 0) {
/* 196 */       if (isSetCookie2) {
/* 197 */         return this.strict.formatCookies(cookies);
/*     */       }
/* 199 */       return this.obsoleteStrict.formatCookies(cookies);
/*     */     } 
/*     */     
/* 202 */     return this.netscapeDraft.formatCookies(cookies);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public int getVersion() {
/* 208 */     return this.strict.getVersion();
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/apache/http/impl/cookie/DefaultCookieSpec.class
