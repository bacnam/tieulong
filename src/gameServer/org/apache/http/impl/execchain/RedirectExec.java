...
/*     */       
/*     */       try {
/* 113 */         if (config.isRedirectsEnabled() && this.redirectStrategy.isRedirected((HttpRequest)currentRequest, (HttpResponse)response, (HttpContext)context)) {
/*     */ 
/*     */           
...
/* 119 */           redirectCount++;
/*     */           
/* 121 */           HttpUriRequest httpUriRequest = this.redirectStrategy.getRedirect((HttpRequest)currentRequest, (HttpResponse)response, (HttpContext)context);
/*     */           
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/apache/http/impl/execchain/RedirectExec.class
