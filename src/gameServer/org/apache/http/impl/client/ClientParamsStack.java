...
/*     */     
/* 197 */     if (this.overrideParams != null) {
/* 198 */       result = this.overrideParams.getParameter(name);
/*     */     }
/* 200 */     if (result == null && this.requestParams != null) {
/* 201 */       result = this.requestParams.getParameter(name);
/*     */     }
/* 203 */     if (result == null && this.clientParams != null) {
/* 204 */       result = this.clientParams.getParameter(name);
/*     */     }
/* 206 */     if (result == null && this.applicationParams != null) {
/* 207 */       result = this.applicationParams.getParameter(name);
/*     */     }
/* 209 */     return result;
/*     */   }
/*     */ 
...
/* 246 */     throw new UnsupportedOperationException("Removing parameters in a stack is not supported.");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/apache/http/impl/client/ClientParamsStack.class
