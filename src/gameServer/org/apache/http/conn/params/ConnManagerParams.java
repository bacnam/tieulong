...
/* 101 */     Args.notNull(params, "HTTP parameters");
/* 102 */     params.setParameter("http.conn-manager.max-per-route", connPerRoute);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 114 */     ConnPerRoute connPerRoute = (ConnPerRoute)params.getParameter("http.conn-manager.max-per-route");
/* 115 */     if (connPerRoute == null) {
/* 116 */       connPerRoute = DEFAULT_CONN_PER_ROUTE;
/*     */     }
/* 118 */     return connPerRoute;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 130 */     Args.notNull(params, "HTTP parameters");
/* 131 */     params.setIntParameter("http.conn-manager.max-total", maxTotalConnections);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 144 */     return params.getIntParameter("http.conn-manager.max-total", 20);
/*     */   }
/*     */ }


/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/apache/http/conn/params/ConnManagerParams.class
