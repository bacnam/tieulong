...
/*     */     } 
/* 406 */     int socketTimeout = HttpConnectionParams.getSoTimeout(params);
/* 407 */     int connectTimeout = HttpConnectionParams.getConnectionTimeout(params);
/* 408 */     socket.setSoTimeout(socketTimeout);
/* 409 */     return connectSocket(connectTimeout, socket, host, remoteAddress, localAddress, (HttpContext)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/* 477 */     HttpInetSocketAddress httpInetSocketAddress = new HttpInetSocketAddress(new HttpHost(host, port), remote, port);
/*     */     
/* 479 */     return connectSocket(socket, (InetSocketAddress)httpInetSocketAddress, localAddress, params);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 503 */     if (this.supportedProtocols != null) {
/* 504 */       socket.setEnabledProtocols(this.supportedProtocols);
/*     */     }
/* 506 */     if (this.supportedCipherSuites != null) {
/* 507 */       socket.setEnabledCipherSuites(this.supportedCipherSuites);
/*     */     }
/* 509 */     prepareSocket(socket);
/*     */   }
/*     */   
/*     */   public Socket createSocket(HttpContext context) throws IOException {
/* 513 */     SSLSocket sock = (SSLSocket)this.socketfactory.createSocket();
...
/* 527 */     Socket sock = (socket != null) ? socket : createSocket(context);
...
/*     */       try {
/* 535 */         sock.close();
/* 536 */       } catch (IOException ignore) {}
/*     */       
/* 538 */       throw ex;
/*     */     } 
/*     */     
/* 541 */     if (sock instanceof SSLSocket) {
/* 542 */       SSLSocket sslsock = (SSLSocket)sock;
...
/* 556 */     SSLSocket sslsock = (SSLSocket)this.socketfactory.createSocket(socket, target, port, true);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*     */       
/* 573 */       try { sslsock.close(); } catch (Exception x) {}
/* 574 */       throw iox;
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/org/apache/http/conn/ssl/SSLSocketFactory.class
