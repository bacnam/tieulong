...
(new String[1])[0] = cn; verify(host, (cn != null) ? new String[1] : null, (subjectAlts != null && !subjectAlts.isEmpty()) ? subjectAlts.<String>toArray(new String[subjectAlts.size()]) : null);
}
...
(new String[1])[0] = cn; return (cn != null) ? new String[1] : null;
} catch (SSLException ex) {
return null;
} 
}
...
return (subjectAlts != null && !subjectAlts.isEmpty()) ? subjectAlts.<String>toArray(new String[subjectAlts.size()]) : null;
}
