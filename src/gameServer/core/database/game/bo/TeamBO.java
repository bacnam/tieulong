...
this.teamType = 0;
this.fightPower = 0;
this.battleCard = new ArrayList<>(4); int i;
for (i = 0; i < 4; i++) {
...
strBuf.append("'").append(this.fightPower).append("', "); int i;
...
} public List<Integer> getBattleCardAll() { return new ArrayList<>(this.battleCard); }
public void setBattleCardAll(int value) { for (int i = 0; i < this.battleCard.size(); ) { this.battleCard.set(i, Integer.valueOf(value)); i++; }
} public void saveBattleCardAll(int value) { setBattleCardAll(value); saveAll(); } public int getBattleCard(int index) {
...
} public List<Integer> getReserveCardAll() { return new ArrayList<>(this.reserveCard); }
public void setReserveCardAll(int value) { for (int i = 0; i < this.reserveCard.size(); ) { this.reserveCard.set(i, Integer.valueOf(value)); i++; }
} public void saveReserveCardAll(int value) { setReserveCardAll(value); saveAll(); } public int getReserveCard(int index) {
...
} public List<Integer> getPositionAll() { return new ArrayList<>(this.position); }
public void setPositionAll(int value) { for (int i = 0; i < this.position.size(); ) { this.position.set(i, Integer.valueOf(value)); i++; }
} public void savePositionAll(int value) { setPositionAll(value); saveAll(); } public int getPosition(int index) {
...
sBuilder.append(" `fightPower` = '").append(this.fightPower).append("',"); int i;
for (i = 0; i < this.battleCard.size(); i++) {
