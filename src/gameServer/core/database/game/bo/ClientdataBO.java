...
} public List<String> getVstrAll() { return new ArrayList<>(this.vstr); }
public void setVstrAll(String value) { for (int i = 0; i < this.vstr.size(); ) { this.vstr.set(i, value); i++; }
} public void saveVstrAll(String value) { setVstrAll(value); saveAll(); } public String getVstr(int index) {
