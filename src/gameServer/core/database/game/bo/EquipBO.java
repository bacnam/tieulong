...
} public List<Integer> getAttrAll() { return new ArrayList<>(this.attr); }
public void setAttrAll(int value) { for (int i = 0; i < this.attr.size(); ) { this.attr.set(i, Integer.valueOf(value)); i++; }
} public void saveAttrAll(int value) { setAttrAll(value); saveAll(); } public int getAttr(int index) {
