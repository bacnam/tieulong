...
/*  40 */     list.add(new LongnvApplyBO(rs));
/*     */   }
/*     */ 
/*     */   
...
/* 140 */     String sql = "CREATE TABLE IF NOT EXISTS `longnvApply` (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',`pid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家pid',`guildId` bigint(20) NOT NULL DEFAULT '0' COMMENT '帮会Id',`applyTime` int(11) NOT NULL DEFAULT '0' COMMENT '申请时间',PRIMARY KEY (`id`)) COMMENT='帮会成员信息'  DEFAULT CHARSET=utf8 AUTO_INCREMENT=" + (
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/core/database/game/bo/LongnvApplyBO.class
