...
/*    */ 
/*    */ public class LotteryChargeLogFlow
/*    */   extends DBFlowBase
/*    */ {
...
/*    */ 
/*    */   
/*    */   public LotteryChargeLogFlow() {}
/*    */   
/*    */   public LotteryChargeLogFlow(long pid, int vip_level, int level, int reason, int num, int cur_remainder, int pre_value, int type) {
/* 34 */     this.pid = pid;
...
/*    */   }
/*    */   
/* 44 */   public static String TABLE_NAME = "LotteryChargeLog";
/*    */ 
/*    */   
...
/* 53 */     return "INSERT INTO LotteryChargeLog(`server_id`, `timestamp`, `date_time`, `pid`, `vip_level`, `level`, `reason`, `num`, `cur_remainder`, `pre_value`, `type`)values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   public static String getCreateTableSQL() {
/* 59 */     String sql = "CREATE TABLE IF NOT EXISTS `LotteryChargeLog` (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',`server_id` int(11) NOT NULL DEFAULT '0' COMMENT '服务器ID',`timestamp` int(11) NOT NULL DEFAULT '0' COMMENT '日志时间(时间戳)',`date_time` varchar(500) NOT NULL DEFAULT '20160801' COMMENT '日志时间(yyyymmdd)',`pid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家pid',`vip_level` int(11) NOT NULL DEFAULT '0' COMMENT 'VIP等级',`level` int(11) NOT NULL DEFAULT '0' COMMENT '队伍等级',`reason` int(11) NOT NULL DEFAULT '0' COMMENT '产生原因类型',`num` int(11) NOT NULL DEFAULT '0' COMMENT '数量',`cur_remainder` int(11) NOT NULL DEFAULT '0' COMMENT '当前剩余',`pre_value` int(11) NOT NULL DEFAULT '0' COMMENT '前值',`type` int(11) NOT NULL DEFAULT '0' COMMENT '类型(1:获得,2:消耗)',PRIMARY KEY (`id`)) COMMENT='lottery Charge 神装碎片消费日志' DEFAULT CHARSET=utf8";
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/core/logger/flow/impl/db/LotteryChargeLogFlow.class
