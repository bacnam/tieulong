...
/*  29 */     CommLog.info("收到充值回调：", request.getRequestBody());
/*  30 */     synchronized (this.Lock) {
/*  31 */       JsonObject params = HttpUtils.abstractGMParams(request.getRequestBody(), "cYUPYnZgCiy0zUBg9KRRXM7H4GUsRKpI");
/*  32 */       int ordertype = HttpUtils.getInt(params, "ordertype");
/*  33 */       if (ordertype != 1) {
/*  34 */         response.error(30011, "暂不支持退单功能", new Object[0]);
/*     */         return;
/*     */       } 
/*  37 */       long cid = HttpUtils.getLong(params, "cid");
/*  38 */       Player player = PlayerMgr.getInstance().getPlayer(cid);
/*  39 */       if (player == null) {
/*  40 */         response.error(30011, "该服务器上无该玩家[%s]", new Object[] { Long.valueOf(cid) });
/*     */         
/*     */         return;
/*     */       } 
/*  44 */       SyncTaskManager.task(() -> {
/*     */             try {
...
/* 102 */     JsonObject params = HttpUtils.abstractGMParams(request.getRequestBody());
/* 103 */     String goodsid = HttpUtils.getString(params, "goodsid");
/*     */     
/* 105 */     RefRecharge ref = (RefRecharge)RefDataMgr.get(RefRecharge.class, goodsid);
/* 106 */     if (ref == null) {
/* 107 */       response.error(30011, "并无商品[%s]", new Object[] { goodsid });
/*     */       return;
/*     */     } 
/* 110 */     RechargeMgr.getInstance().reset(goodsid);
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/core/network/http/handler/Recharge.class
