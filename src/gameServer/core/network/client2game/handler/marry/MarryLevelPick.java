...
/* 38 */     Reward reward = feature.pickLevelReward(req.level);
/* 39 */     List<Integer> alreadyPick = StringUtils.string2Integer(feature.bo.getLevelReward());
/* 40 */     request.response(new Response(alreadyPick, reward));
/*    */   }
/*    */ }


/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/core/network/client2game/handler/marry/MarryLevelPick.class
