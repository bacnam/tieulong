...
for (i = (arrayOfInstanceType = InstanceType.values()).length, b = 0; b < i; ) { InstanceType instanceType = arrayOfInstanceType[b];
instanceMap.put(instanceType, Lists.newArrayList()); b++; }
