...
/*  57 */     return new Duration((long)value);
/*     */   }
/*     */   
/*     */   public static Duration buildBySeconds(double value) {
/*  61 */     return new Duration((long)(1000.0D * value));
/*     */   }
/*     */   
/*     */   public static Duration buildByMinutes(double value) {
/*  65 */     return new Duration((long)(60000.0D * value));
/*     */   }
/*     */   
/*     */   public static Duration buildByHours(double value) {
/*  69 */     return new Duration((long)(3600000.0D * value));
/*     */   }
/*     */   
/*     */   public static Duration buildByDays(double value) {
/*  73 */     return new Duration((long)(8.64E7D * value));
/*     */   }
/*     */   
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/core/util/Duration.class
