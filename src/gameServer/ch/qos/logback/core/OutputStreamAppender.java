...
/* 134 */         addStatus((Status)new ErrorStatus("Could not close output stream for OutputStreamAppender.", this, e));
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/* 146 */         addStatus((Status)new ErrorStatus("Failed to initialize encoder for appender named [" + this.name + "].", this, ioe));
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/* 159 */         addStatus((Status)new ErrorStatus("Failed to write footer for appender named [" + this.name + "].", this, ioe));
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/* 227 */       addStatus((Status)new ErrorStatus("IO failure in appender", this, ioe));
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/core/OutputStreamAppender.class
