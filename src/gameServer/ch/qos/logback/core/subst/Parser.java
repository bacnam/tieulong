...
/*     */     Token right;
/*     */     Node curlyLeft, v;
/*  75 */     Token w, t = peekAtCurentToken();
/*     */     
/*  77 */     switch (t.type) {
/*     */       case LITERAL:
...
/*  83 */         innerNode = C();
/*  84 */         right = peekAtCurentToken();
/*  85 */         expectCurlyRight(right);
/*  86 */         advanceTokenPointer();
/*  87 */         curlyLeft = makeNewLiteralNode(CoreConstants.LEFT_ACCOLADE);
...
/* 158 */       return this.tokenList.get(this.pointer);
/*     */     }
/* 160 */     return null;
/*     */   }
/*     */ }
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/core/subst/Parser.class
