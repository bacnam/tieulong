...
/*  90 */       this.evaluatorList = new ArrayList<EventEvaluator<ILoggingEvent>>();
/*     */     }
...
/*  97 */       this.ignoredStackTraceLines = new ArrayList<String>();
/*     */     }
...
/* 122 */         EventEvaluator<ILoggingEvent> ee = this.evaluatorList.get(i);
/*     */         try {
/* 124 */           if (ee.evaluate(event)) {
/* 125 */             printStack = false;
/*     */             break;
/*     */           } 
/* 128 */         } catch (EvaluationException eex) {
/* 129 */           this.errorCount++;
/* 130 */           if (this.errorCount < 4) {
/* 131 */             addError("Exception thrown for evaluator named [" + ee.getName() + "]", (Throwable)eex);
/*     */           }
/* 133 */           else if (this.errorCount == 4) {
/* 134 */             ErrorStatus errorStatus = new ErrorStatus("Exception thrown for evaluator named [" + ee.getName() + "].", this, (Throwable)eex);
/*     */ 
/*     */             
/* 137 */             errorStatus.add((Status)new ErrorStatus("This was the last warning about this evaluator's errors.We don't want the StatusManager to get flooded.", this));
/*     */ 
/*     */             
/* 140 */             addStatus((Status)errorStatus);
/*     */           } 
/*     */         } 
/*     */       } 
/*     */       
...
/*     */     
/* 156 */     recursiveAppend(sb, (String)null, 1, tp);
/*     */     
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/classic/pattern/ThrowableProxyConverter.class
