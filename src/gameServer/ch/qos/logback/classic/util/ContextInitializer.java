...
/*  71 */         sm.add((Status)new ErrorStatus("Groovy classes are not available on the class path. ABORTING INITIALIZATION.", this.loggerContext));
/*     */       }
/*     */     
/*  74 */     } else if (urlString.endsWith("xml")) {
/*  75 */       JoranConfigurator configurator = new JoranConfigurator();
/*  76 */       configurator.setContext((Context)this.loggerContext);
...
/*  85 */     configurator.setContext((Context)this.loggerContext);
...
/*     */     } else {
/* 154 */       Configurator c = EnvUtil.<Configurator>loadFromServiceLoader(Configurator.class);
/* 155 */       if (c != null) {
/*     */         try {
/* 157 */           c.setContext((Context)this.loggerContext);
...
/* 175 */       sm.add((Status)new ErrorStatus("Failed to get url list for resource [" + resourceName + "]", this.loggerContext, e));
/*     */     } 
/*     */     
/* 178 */     if (urlSet != null && urlSet.size() > 1) {
/* 179 */       sm.add((Status)new WarnStatus("Resource [" + resourceName + "] occurs multiple times on the classpath.", this.loggerContext));
/*     */       
/* 181 */       for (URL url : urlSet) {
/* 182 */         sm.add((Status)new WarnStatus("Resource [" + resourceName + "] occurs at [" + url.toString() + "]", this.loggerContext));
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 190 */     if (url == null) {
/* 191 */       sm.add((Status)new InfoStatus("Could NOT find resource [" + resourceName + "]", this.loggerContext));
/*     */     } else {
/*     */       
/* 194 */       sm.add((Status)new InfoStatus("Found resource [" + resourceName + "] at [" + url.toString() + "]", this.loggerContext));
/*     */       
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/classic/util/ContextInitializer.class
