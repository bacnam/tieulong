...
/*     */   static {
/*     */     try {
/*  74 */       method = PreparedStatement.class.getMethod("getGeneratedKeys", (Class[])null);
/*     */     }
/*  76 */     catch (Exception ex) {
/*  77 */       method = null;
/*     */     } 
/*  79 */     GET_GENERATED_KEYS_METHOD = method;
/*     */   }
/*     */   
...
/*  89 */       this.dbNameResolver = (DBNameResolver)new DefaultDBNameResolver(); 
...
/*     */     int i;
/* 137 */     for (i = 0; i < arrayLen && i < 4; i++) {
/* 138 */       stmt.setString(7 + i, asStringTruncatedTo254(argArray[i]));
/*     */     }
/* 140 */     if (arrayLen < 4) {
/* 141 */       for (i = arrayLen; i < 4; i++) {
/* 142 */         stmt.setString(7 + i, (String)null);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 186 */     Map<String, String> mergedMap = new HashMap<String, String>();
/*     */ 
/*     */ 
/*     */     
...
/* 223 */           String value = mergedMap.get(key);
/*     */           
...
/* 230 */             insertPropertiesStatement.addBatch(); continue;
/*     */           } 
...
/*     */         }
/*     */       } finally {
/* 240 */         DBHelper.closeStatement(insertPropertiesStatement);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/*     */       }
/*     */     } finally {
/* 309 */       DBHelper.closeStatement(exceptionStatement);
/*     */     } 
/*     */   }
/*     */ }


/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/classic/db/DBAppender.class
