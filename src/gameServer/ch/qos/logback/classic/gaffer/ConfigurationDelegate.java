...
CallSite[] arrayOfCallSite = $getCallSiteArray(); List<Appender> list = ScriptBytecodeAdapter.createList(new Object[0]); MetaClass metaClass = $getStaticMetaClass();
}
public Object getDeclaredOrigin() {
CallSite[] arrayOfCallSite = $getCallSiteArray(); return this;
}
...
arrayOfCallSite[6].callCurrent(this, arrayOfCallSite[7].call("Setting ReconfigureOnChangeFilter scanning period to ", duration)); } catch (NumberFormatException nfe)
...
CallSite[] arrayOfCallSite = $getCallSiteArray(); String converterClassName = ShortTypeHandling.castToString(arrayOfCallSite[25].call(converterClass));
...
Object object = arrayOfCallSite[29].callConstructor(HashMap.class); ruleRegistry = (Map)ScriptBytecodeAdapter.castToType(object, Map.class);
...
public void root(Level level) { CallSite[] arrayOfCallSite = $getCallSiteArray(); root(level, ScriptBytecodeAdapter.createList(new Object[0])); null; } public void root(Level level, List appenderNames) {
CallSite[] arrayOfCallSite = $getCallSiteArray(); if (ScriptBytecodeAdapter.compareEqual(level, null)) {
...
public void logger(String name, Level level) { CallSite[] arrayOfCallSite = $getCallSiteArray(); logger(name, level, ScriptBytecodeAdapter.createList(new Object[0]), null); null; }
public void logger(String name, Level level, List appenderNames, Boolean additivity) { CallSite[] arrayOfCallSite = $getCallSiteArray(); if (DefaultTypeTransformation.booleanUnbox(name)) {
...
Level level1 = level; ScriptBytecodeAdapter.setProperty(level1, null, logger, "level"); Reference aName;
Iterator iterator;
for (aName = new Reference(null), iterator = (Iterator)ScriptBytecodeAdapter.castToType(arrayOfCallSite[46].call(appenderNames), Iterator.class); iterator.hasNext(); ) { aName.set(iterator.next());
...
arrayOfCallSite[50].call(logger, appender); continue;
} 
...
Boolean bool = additivity; ScriptBytecodeAdapter.setProperty(bool, null, logger, "additive");
} 
} else {
...
Object object = arrayOfCallSite[61].callGroovyObjectGetProperty(this); ScriptBytecodeAdapter.setProperty(object, null, appender, "context");
...
Object object1 = arrayOfCallSite[65].callGroovyObjectGetProperty(this); ScriptBytecodeAdapter.setGroovyObjectProperty(object1, ConfigurationDelegate.class, ad, "context");
AppenderDelegate appenderDelegate1 = ad; ScriptBytecodeAdapter.setGroovyObjectProperty(appenderDelegate1, ConfigurationDelegate.class, (GroovyObject)closure, "delegate");
Object object2 = arrayOfCallSite[66].callGetProperty(Closure.class); ScriptBytecodeAdapter.setGroovyObjectProperty(object2, ConfigurationDelegate.class, (GroovyObject)closure, "resolveStrategy");
arrayOfCallSite[67].call(closure);
} 

try { arrayOfCallSite[68].call(appender); } catch (RuntimeException e)
...
Object object1 = arrayOfCallSite[80].callGroovyObjectGetProperty(this); ScriptBytecodeAdapter.setGroovyObjectProperty(object1, ConfigurationDelegate.class, componentDelegate, "context");
ComponentDelegate componentDelegate1 = componentDelegate; ScriptBytecodeAdapter.setGroovyObjectProperty(componentDelegate1, ConfigurationDelegate.class, (GroovyObject)closure, "delegate");
Object object2 = arrayOfCallSite[81].callGetProperty(Closure.class); ScriptBytecodeAdapter.setGroovyObjectProperty(object2, ConfigurationDelegate.class, (GroovyObject)closure, "resolveStrategy");
arrayOfCallSite[82].call(closure);
} 

try { arrayOfCallSite[83].call(receiver); } catch (RuntimeException e)
...
Reference reference1 = new Reference(appenderDelegate), reference2 = new Reference(appender); CallSite[] arrayOfCallSite = $getCallSiteArray(); if ((Appender)reference2.get() instanceof ConfigurationContributor)
...
Object object = arrayOfCallSite[95].callGroovyObjectGetProperty(this); ScriptBytecodeAdapter.setProperty(object, null, turboFilter, "context");
...
Object object1 = arrayOfCallSite[97].callGroovyObjectGetProperty(this); ScriptBytecodeAdapter.setGroovyObjectProperty(object1, ConfigurationDelegate.class, componentDelegate, "context");
ComponentDelegate componentDelegate1 = componentDelegate; ScriptBytecodeAdapter.setGroovyObjectProperty(componentDelegate1, ConfigurationDelegate.class, (GroovyObject)closure, "delegate");
Object object2 = arrayOfCallSite[98].callGetProperty(Closure.class); ScriptBytecodeAdapter.setGroovyObjectProperty(object2, ConfigurationDelegate.class, (GroovyObject)closure, "resolveStrategy");
...
Object object = arrayOfCallSite[105].call(System.class); now = DefaultTypeTransformation.longUnbox(object);
} else {
...
try { Object object = arrayOfCallSite[113].callConstructor(ObjectName.class, name); } catch (MalformedObjectNameException e)
...
try { arrayOfCallSite[122].call(platformMBeanServer, jmxConfigurator, objectName); } catch (Exception all)
