...
/* 168 */           this.buf.append("\r\n    <log4j:data");
/* 169 */           this.buf.append(" name='" + Transform.escapeTags(entry.getKey()) + "'");
/* 170 */           this.buf.append(" value='" + Transform.escapeTags(entry.getValue()) + "'");
/* 171 */           this.buf.append(" />");
/*     */         } 
/* 173 */         this.buf.append("\r\n  </log4j:properties>");
/*     */       } 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/classic/log4j/XMLLayout.class
