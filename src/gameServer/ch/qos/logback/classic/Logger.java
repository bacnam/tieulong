...
/* 170 */         Logger child = this.childrenList.get(i);
/*     */         
...
/* 195 */           Logger child = this.childrenList.get(i);
...
/* 314 */       this.childrenList = new ArrayList<Logger>();
/*     */     }
/*     */     
/* 317 */     if (isRootLogger()) {
...
/* 365 */       this.childrenList = new ArrayList<Logger>(5);
/*     */     }
/*     */     
...
/* 442 */     callAppenders((ILoggingEvent)le);
/*     */   }
/*     */   
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/classic/Logger.class
