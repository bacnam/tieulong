...
/*     */   
/*  32 */   HashMap<String, ClassPackagingData> cache = new HashMap<String, ClassPackagingData>();
/*     */ 
/*     */ 
/*     */   
...
/* 120 */     ClassPackagingData cpd = this.cache.get(className);
/* 121 */     if (cpd != null) {
/* 122 */       return cpd;
/*     */     }
...
/* 134 */     ClassPackagingData cpd = this.cache.get(className);
/* 135 */     if (cpd != null) {
/* 136 */       return cpd;
/*     */     }
...
/* 241 */       return null;
/* 242 */     } catch (NoClassDefFoundError e1) {
/* 243 */       return null;
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/ch/qos/logback/classic/spi/PackagingDataCalculator.class
