...
if (this.birthTime != that.birthTime) return false; 
if ((this.name != null) ? !this.name.equals(that.name) : (that.name != null)) return false; 
if ((this.propertyMap != null) ? !this.propertyMap.equals(that.propertyMap) : (that.propertyMap != null)) return false;
...
result = 31 * result + (int)(this.birthTime ^ this.birthTime >>> 32L);
