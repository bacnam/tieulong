...
switch (this.sort) { case 0:
buf.append('V'); return;
case 1: buf.append('Z'); return;
case 2: buf.append('C'); return;
case 3: buf.append('B'); return;
case 4: buf.append('S'); return;
case 5: buf.append('I'); return;
case 6: buf.append('F'); return;
case 7: buf.append('J'); return;
case 8: buf.append('D');
return; }
...
buf.append(car); return;
} 
if (d.isArray()) {
buf.append('[');
d = (Class)d.getComponentType(); continue;
}  break;
}  buf.append('L');
