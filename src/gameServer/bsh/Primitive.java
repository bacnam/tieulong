...
{
static Hashtable wrapperMap = new Hashtable<Object, Object>(); private Object value;
static {
...
public Primitive(float value) { this(new Float(value)); } public Primitive(double value) {
...
Class<byte> operandType = val.getType();
