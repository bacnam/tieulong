...
/*    */ {
/* 69 */   static final ResourcePoolFactory SHARED_INSTANCE = new BasicResourcePoolFactory();
/*    */   
...
/* 75 */     return SHARED_INSTANCE;
/*    */   }
/*    */   public static ResourcePoolFactory createInstance() {
/* 78 */     return new BasicResourcePoolFactory();
/*    */   }
/*    */   public static ResourcePoolFactory createInstance(int num_task_threads) {
/* 81 */     return new BasicResourcePoolFactory(num_task_threads);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 90 */     return new BasicResourcePoolFactory(taskRunner, asyncEventQueue, cullTimer);
/*    */   }
/*    */ 
/*    */   
/*    */   public static ResourcePoolFactory createInstance(Queuable taskRunnerEventQueue, Timer cullTimer) {
/* 95 */     return createInstance((AsynchronousRunner)taskRunnerEventQueue, (taskRunnerEventQueue == null) ? null : taskRunnerEventQueue.asRunnableQueue(), cullTimer);
/*    */   }
/*    */   
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mchange/v2/resourcepool/ResourcePoolFactory.class
