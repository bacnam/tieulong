...
/*     */     
/* 152 */     final ThreadFactory backingThreadFactory = (builder.backingThreadFactory != null) ? builder.backingThreadFactory : Executors.defaultThreadFactory();
/*     */ 
/*     */ 
/*     */     
...
/* 161 */             thread.setName(String.format(nameFormat, new Object[] { Long.valueOf(this.val$count.getAndIncrement()) }));
/*     */           }
/* 163 */           if (daemon != null) {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/google/common/util/concurrent/ThreadFactoryBuilder.class
