...
/*     */           }
/*     */           
/* 113 */           target = thatIterator.next(); continue;
/*     */         } 
/* 115 */         if (cmp > 0) {
/* 116 */           return false;
/*     */         }
...
/* 137 */     Comparator<Object> unsafeComparator = (Comparator)this.comparator;
/*     */     
/* 139 */     return Collections.binarySearch(this.elements, (E)key, (Comparator)unsafeComparator);
/*     */   }
/*     */   
...
/* 151 */     return (T[])this.elements.toArray((Object[])array);
/*     */   }
/*     */   
...
/*     */     int index;
/* 202 */     if (inclusive) {
/* 203 */       index = SortedLists.binarySearch(this.elements, (E)Preconditions.checkNotNull(toElement), comparator(), SortedLists.KeyPresentBehavior.FIRST_AFTER, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
/*     */     } else {
/*     */       
/* 206 */       index = SortedLists.binarySearch(this.elements, (E)Preconditions.checkNotNull(toElement), comparator(), SortedLists.KeyPresentBehavior.FIRST_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
/*     */     } 
/*     */     
...
/*     */     int index;
/* 222 */     if (inclusive) {
/* 223 */       index = SortedLists.binarySearch(this.elements, (E)Preconditions.checkNotNull(fromElement), comparator(), SortedLists.KeyPresentBehavior.FIRST_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
/*     */     } else {
/*     */       
/* 226 */       index = SortedLists.binarySearch(this.elements, (E)Preconditions.checkNotNull(fromElement), comparator(), SortedLists.KeyPresentBehavior.FIRST_AFTER, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
/*     */     } 
/*     */     
...
/* 237 */     return (Comparator)this.comparator;
/*     */   }
/*     */   
...
/*     */     
/*     */     try {
/* 258 */       position = SortedLists.binarySearch(this.elements, (E)target, comparator(), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.INVERTED_INSERTION_INDEX);
/*     */     }
...
/* 273 */     return new ImmutableSortedAsList<E>(this, this.elements);
/*     */   }
/*     */ }


/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/google/common/collect/RegularImmutableSortedSet.class
