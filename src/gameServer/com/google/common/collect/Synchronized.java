...
/*  298 */     return (list instanceof RandomAccess) ? new SynchronizedRandomAccessList<E>(list, mutex) : new SynchronizedList<E>(list, mutex);
/*      */   }
/*      */   
...
/*  476 */           this.entrySet = (Set)Synchronized.typePreservingSet((Set)delegate().entrySet(), this.mutex);
/*      */         }
...
/*  641 */           this.entries = (Collection)Synchronized.typePreservingCollection((Collection)delegate().entries(), this.mutex);
/*      */         }
...
/*  651 */           this.asMap = new Synchronized.SynchronizedAsMap<K, V>(delegate().asMap(), this.mutex);
/*      */         }
...
/*  851 */             return (Map.Entry)new ForwardingMapEntry<K, Collection<Collection<V>>>() {
...
/* 1171 */           this.asMapEntrySet = new Synchronized.SynchronizedAsMapEntries<K, V>(delegate().entrySet(), this.mutex);
/*      */         }
/*      */         
...
/* 1181 */           this.asMapValues = new Synchronized.SynchronizedAsMapValues<V>(delegate().values(), this.mutex);
/*      */         }
/*      */         
...
/* 1211 */             return Synchronized.typePreservingCollection(iterator.next(), Synchronized.SynchronizedAsMapValues.this.mutex);
/*      */           }
/*      */         };
/*      */     }
/*      */   }
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/google/common/collect/Synchronized.class
