...
root = (N)root.childOrNull(side.other()); continue;
} 
...
return balancePolicy.balance(nodeFactory, root, left, right);case RIGHT: left = subTreeBeyondRangeToSide(range, balancePolicy, nodeFactory, BstSide.RIGHT, left); return balancePolicy.balance(nodeFactory, root, left, right);
