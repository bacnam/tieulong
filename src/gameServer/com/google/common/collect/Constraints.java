...
/*  92 */       this.delegate = (Collection<E>)Preconditions.checkNotNull(delegate);
/*  93 */       this.constraint = (Constraint<? super E>)Preconditions.checkNotNull(constraint);
/*     */     }
...
/* 103 */       return this.delegate.addAll(Constraints.checkElements((Collection)elements, this.constraint));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */       this.delegate = (Set<E>)Preconditions.checkNotNull(delegate);
/* 131 */       this.constraint = (Constraint<? super E>)Preconditions.checkNotNull(constraint);
/*     */     }
...
/*     */     }
/*     */     public boolean addAll(Collection<? extends E> elements) {
/* 141 */       return this.delegate.addAll(Constraints.checkElements((Collection)elements, this.constraint));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 169 */       this.delegate = (SortedSet<E>)Preconditions.checkNotNull(delegate);
/* 170 */       this.constraint = (Constraint<? super E>)Preconditions.checkNotNull(constraint);
/*     */     }
...
/*     */     }
/*     */     public boolean addAll(Collection<? extends E> elements) {
/* 190 */       return this.delegate.addAll(Constraints.checkElements((Collection)elements, this.constraint));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */     return (list instanceof RandomAccess) ? new ConstrainedRandomAccessList<E>(list, constraint) : new ConstrainedList<E>(list, constraint);
/*     */   }
/*     */ 
/*     */   
/*     */   @GwtCompatible
...
/* 221 */       this.delegate = (List<E>)Preconditions.checkNotNull(delegate);
/* 222 */       this.constraint = (Constraint<? super E>)Preconditions.checkNotNull(constraint);
/*     */     }
...
/*     */     }
/*     */     public boolean addAll(Collection<? extends E> elements) {
/* 237 */       return this.delegate.addAll(Constraints.checkElements((Collection)elements, this.constraint));
/*     */     }
/*     */     
/*     */     public boolean addAll(int index, Collection<? extends E> elements) {
/* 241 */       return this.delegate.addAll(index, Constraints.checkElements((Collection)elements, this.constraint));
/*     */     }
...
/* 343 */       this.delegate = (Multiset<E>)Preconditions.checkNotNull(delegate);
/* 344 */       this.constraint = (Constraint<? super E>)Preconditions.checkNotNull(constraint);
/*     */     }
...
/*     */     }
/*     */     public boolean addAll(Collection<? extends E> elements) {
/* 353 */       return this.delegate.addAll(Constraints.checkElements((Collection)elements, this.constraint));
/*     */     }
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/google/common/collect/Constraints.class
