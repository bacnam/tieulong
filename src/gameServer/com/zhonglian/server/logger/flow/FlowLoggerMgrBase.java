...
Method[] baseMethod = Object.class.getDeclaredMethods(); byte b; int i;
Method[] arrayOfMethod1;
for (i = (arrayOfMethod1 = baselogger.getMethods()).length, b = 0; b < i; ) { Method method = arrayOfMethod1[b];
...
FlowLoggerBase flowLoggerBase; Logger logger = null;
try {
...
return true; } private boolean isInSuperType(Method method, Method[] baseMethod) {
byte b;
int i;
Method[] arrayOfMethod;
for (i = (arrayOfMethod = baseMethod).length, b = 0; b < i; ) { Method m = arrayOfMethod[b];
