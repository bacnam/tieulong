...
boolean parameterAsBoolean; switch (targetSqlType) {
case -7:
if ("1".equals(parameterObj) || "0".equals(parameterObj)) {

Number number = Integer.valueOf((String)parameterObj); break;
} 
...
setBigDecimal(parameterIndex, scaledBigDecimal); break;
...
try {
Date parameterAsDate; switch (targetSqlType) {
...
setClob(parameterIndex, (Clob)parameterObj); break;
} 
setString(parameterIndex, parameterObj.toString());
break;
...
setBytes(parameterIndex, (byte[])parameterObj); break;
}  if (parameterObj instanceof Blob) {
setBlob(parameterIndex, (Blob)parameterObj); break;
} 
...
setTime(parameterIndex, new Time(sdf.parse((String)parameterObj).getTime())); break;
} 
if (parameterObj instanceof Timestamp) {
Timestamp xT = (Timestamp)parameterObj;
setTime(parameterIndex, new Time(xT.getTime())); break;
} 
setTime(parameterIndex, (Time)parameterObj);
break;
