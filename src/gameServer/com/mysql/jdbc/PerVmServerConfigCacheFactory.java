...
/*    */ {
/* 34 */   static final ConcurrentHashMap<String, Map<String, String>> serverConfigByUrl = new ConcurrentHashMap<String, Map<String, String>>();
/*    */   
/* 36 */   private static final CacheAdapter<String, Map<String, String>> serverConfigCache = new CacheAdapter<String, Map<String, String>>()
/*    */     {
/*    */       public Map<String, String> get(String key) {
/* 39 */         return PerVmServerConfigCacheFactory.serverConfigByUrl.get(key);
/*    */       }
/*    */       
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/PerVmServerConfigCacheFactory.class
