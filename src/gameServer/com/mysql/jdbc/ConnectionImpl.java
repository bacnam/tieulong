...
/*  132 */         Iterator<Extension> iter = this.interceptors.iterator();
/*      */         
...
/*  144 */         Iterator<Extension> iter = this.interceptors.iterator();
/*      */         
...
/*  155 */         Iterator<Extension> iter = this.interceptors.iterator();
/*      */         
...
/*      */ 
/*      */   
/*  248 */   private static final Log NULL_LOGGER = (Log)new NullLogger("MySQL");
/*      */   
/*      */   protected static Map<?, ?> roundRobinStatsMap;
/*      */   
/*  252 */   private static final Map<String, Map<Long, String>> serverCollationByUrl = new HashMap<String, Map<Long, String>>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  258 */   private static final Map<String, Map<Integer, String>> serverJavaCharsetByUrl = new HashMap<String, Map<Integer, String>>();
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  263 */   private static final Map<String, Map<Integer, String>> serverCustomCharsetByUrl = new HashMap<String, Map<Integer, String>>();
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  268 */   private static final Map<String, Map<String, Integer>> serverCustomMblenByUrl = new HashMap<String, Map<String, Integer>>();
/*      */   
...
/*      */   
/*      */   static {
/*  288 */     mapTransIsolationNameToValue = new HashMap<String, Integer>(8);
...
/*  295 */     if (Util.isJdbc4()) {
/*      */       try {
/*  297 */         JDBC_4_CONNECTION_CTOR = Class.forName("com.mysql.jdbc.JDBC4Connection").getConstructor(new Class[] { String.class, int.class, Properties.class, String.class, String.class });
/*      */ 
/*      */       
/*      */       }
...
/*  423 */   protected static synchronized int getNextRoundRobinHostIndex(String url, List<?> hostList) { int indexRange = hostList.size();
/*      */     
...
/*      */ 
/*      */   
/*  464 */   private Map<String, Object> charsetConverterMap = new HashMap<String, Object>(CharsetMapping.getNumberOfCharsetsConfigured());
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*  477 */   private DatabaseMetaData dbmd = null;
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*  500 */   public Map<Integer, String> indexToJavaCharset = new HashMap<Integer, String>();
/*      */   
/*  502 */   public Map<Integer, String> indexToCustomMysqlCharset = new HashMap<Integer, String>();
/*      */   
/*  504 */   private Map<String, Integer> mysqlCharsetToCustomMblen = new HashMap<String, Integer>();
/*      */ 
/*      */   
...
/*      */   
/*  551 */   private long minimumNumberTablesAccessed = Long.MAX_VALUE;
/*      */ 
/*      */   
...
/*      */   
/*  617 */   private long shortestQueryTimeMs = Long.MAX_VALUE;
/*      */ 
/*      */   
...
/*  868 */     ArrayList<StatementInterceptorV2> unSafedStatementInterceptors = new ArrayList<StatementInterceptorV2>(this.statementInterceptors.size());
/*      */     
...
/*      */     
/*  886 */     List<Extension> unwrappedInterceptors = Util.loadExtensions(this, this.props, getStatementInterceptors(), "MysqlIo.BadStatementInterceptor", getExceptionInterceptor());
/*      */ 
/*      */ 
/*      */     
/*  890 */     this.statementInterceptors = new ArrayList<StatementInterceptorV2>(unwrappedInterceptors.size());
/*      */     
/*  892 */     for (int i = 0; i < unwrappedInterceptors.size(); i++) {
/*  893 */       Extension interceptor = unwrappedInterceptors.get(i);
/*      */ 
/*      */ 
/*      */       
...
/*  924 */           histogramCounts[i] = histogramCounts[i] + numberOfTimes;
/*      */           break;
/*      */         } 
/*      */       } 
/*      */     } 
...
/*      */     
/*  935 */     addToHistogram(this.perfMetricsHistCounts, this.perfMetricsHistBreakpoints, value, numberOfTimes, (this.shortestQueryTimeMs == Long.MAX_VALUE) ? 0L : this.shortestQueryTimeMs, this.longestQueryTimeMs);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*  944 */     addToHistogram(this.numTablesMetricsHistCounts, this.numTablesMetricsHistBreakpoints, value, numberOfTimes, (this.minimumNumberTablesAccessed == Long.MAX_VALUE) ? 0L : this.minimumNumberTablesAccessed, this.maximumNumberTablesAccessed);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  960 */     HashMap<Integer, String> javaCharset = null;
/*      */     
/*  962 */     if (versionMeetsMinimum(4, 1, 0)) {
/*      */       
/*  964 */       TreeMap<Long, String> sortedCollationMap = null;
/*  965 */       HashMap<Integer, String> customCharset = null;
/*  966 */       HashMap<String, Integer> customMblen = null;
/*      */       
/*  968 */       if (getCacheServerConfiguration()) {
/*  969 */         synchronized (serverCollationByUrl) {
/*  970 */           sortedCollationMap = (TreeMap<Long, String>)serverCollationByUrl.get(getURL());
/*  971 */           javaCharset = (HashMap<Integer, String>)serverJavaCharsetByUrl.get(getURL());
/*  972 */           customCharset = (HashMap<Integer, String>)serverCustomCharsetByUrl.get(getURL());
/*  973 */           customMblen = (HashMap<String, Integer>)serverCustomMblenByUrl.get(getURL());
/*      */         } 
/*      */       }
/*      */       
...
/*  982 */           sortedCollationMap = new TreeMap<Long, String>();
/*  983 */           javaCharset = new HashMap<Integer, String>();
/*  984 */           customCharset = new HashMap<Integer, String>();
/*  985 */           customMblen = new HashMap<String, Integer>();
/*      */           
...
/*      */           } 
/*      */           
/* 1004 */           for (Iterator<Map.Entry<Long, String>> indexIter = sortedCollationMap.entrySet().iterator(); indexIter.hasNext(); ) {
/* 1005 */             Map.Entry<Long, String> indexEntry = indexIter.next();
/*      */             
/* 1007 */             int collationIndex = ((Long)indexEntry.getKey()).intValue();
/* 1008 */             String charsetName = indexEntry.getValue();
/*      */             
...
/* 1062 */         SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/*      */     } else {
/*      */       
/* 1083 */       javaCharset = new HashMap<Integer, String>();
...
/*      */     }
/*      */     
/* 1097 */     return CharsetMapping.MYSQL_TO_JAVA_CHARSET_MAP.get(mysqlEncoding);
/*      */   }
/*      */ 
/*      */   
...
/* 1255 */     return (mysqlEncodingName != null && mysqlEncodingName.equalsIgnoreCase(this.serverVariables.get("character_set_client")) && mysqlEncodingName.equalsIgnoreCase(this.serverVariables.get("character_set_connection")));
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/* 1313 */     String serverEncoding = this.serverVariables.get("character_set");
/*      */     
/* 1315 */     if (serverEncoding == null)
/*      */     {
/* 1317 */       serverEncoding = this.serverVariables.get("character_set_server");
/*      */     }
/*      */     
...
/* 1327 */         throw ex;
/* 1328 */       } catch (RuntimeException ex) {
/* 1329 */         SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/* 1380 */       } catch (UnsupportedEncodingException UE) {
...
/*      */     } 
/*      */     
/* 1409 */     String s = this.serverVariables.get(txIsolationName);
/*      */     
/* 1411 */     if (s != null) {
/* 1412 */       Integer intTI = mapTransIsolationNameToValue.get(s);
/*      */       
/* 1414 */       if (intTI != null) {
...
/* 1498 */     PreparedStatement pStmt = clientPrepareStatement(sql);
/*      */     
...
/* 1536 */       PreparedStatement.ParseInfo pStmtInfo = this.cachedPreparedStatementParams.get(nativeSql);
/*      */       
...
/* 1608 */       (new IterateBlock<Extension>(this.connectionLifecycleInterceptors.iterator()) {
...
/*      */     }
/*      */     
/* 1615 */     realClose(true, true, false, (Throwable)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1628 */       List<Statement> currentlyOpenStatements = new ArrayList<Statement>();
/*      */ 
/*      */ 
/*      */       
/* 1632 */       for (Iterator<Statement> iter = this.openStatements.keySet().iterator(); iter.hasNext();) {
...
/* 1686 */         IterateBlock<Extension> iter = new IterateBlock<Extension>(this.connectionLifecycleInterceptors.iterator())
/*      */           {
/*      */             void forEach(Extension each) throws SQLException {
...
/*      */ 
/*      */         
/* 1712 */         execSQL((StatementImpl)null, "commit", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */       
/*      */       }
/*      */ 
/*      */     
/*      */     }
/* 1718 */     catch (SQLException sqlException) {
...
/* 1749 */       } catch (UnsupportedEncodingException UE) {
/*      */         
...
/* 1756 */           throw ex;
/* 1757 */         } catch (RuntimeException ex) {
/* 1758 */           SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/* 1773 */         } catch (UnsupportedEncodingException encodingEx) {
...
/*      */             } else {
/* 1828 */               throw SQLError.createSQLException("Unknown initial character set index '" + this.io.serverCharsetIndex + "' received from server. Initial client character set can be forced via the 'characterEncoding' property.", "S1000", getExceptionInterceptor());
/*      */             } 
/*      */           }
/*      */ 
/*      */ 
...
/*      */         }
/* 1851 */         catch (ArrayIndexOutOfBoundsException outOfBoundsEx) {
/* 1852 */           if (realJavaEncoding != null) {
/*      */             
/* 1854 */             setEncoding(realJavaEncoding);
/*      */           } else {
/* 1856 */             throw SQLError.createSQLException("Unknown initial character set index '" + this.io.serverCharsetIndex + "' received from server. Initial client character set can be forced via the 'characterEncoding' property.", "S1000", getExceptionInterceptor());
/*      */           
/*      */           }
/*      */ 
/*      */         
...
/* 1865 */           SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/*      */                 {
/* 1900 */                   execSQL((StatementImpl)null, "SET NAMES " + (useutf8mb4 ? "utf8mb4" : "utf8"), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */                 
/*      */                 }
/*      */               }
/*      */               else {
/*      */                 
/* 1906 */                 execSQL((StatementImpl)null, "SET NAMES latin1", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */               } 
/*      */ 
/*      */ 
/*      */ 
...
/* 1932 */                   execSQL((StatementImpl)null, "SET NAMES " + mysqlEncodingName, -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */                 }
/*      */               }
/*      */ 
/*      */ 
...
/*      */               try {
/* 1969 */                 execSQL((StatementImpl)null, "SET NAMES " + mysqlEncodingName, -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */               
/*      */               }
...
/* 1995 */           onServer = this.serverVariables.get("character_set_results");
/*      */           
...
/*      */             try {
/* 2009 */               execSQL((StatementImpl)null, "SET character_set_results = NULL", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */             
/*      */             }
...
/*      */             try {
/* 2031 */               execSQL((StatementImpl)null, "SET NAMES latin1", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */             
/*      */             }
...
/*      */ 
/*      */           
/* 2065 */           if (!mysqlEncodingName.equalsIgnoreCase(this.serverVariables.get("character_set_results"))) {
/*      */             
...
/*      */             
/*      */             try {
/* 2074 */               execSQL((StatementImpl)null, setBuf.toString(), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */             
/*      */             }
/* 2078 */             catch (SQLException ex) {
...
/*      */           
/*      */           try {
/* 2110 */             execSQL((StatementImpl)null, setBuf.toString(), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */           
/*      */           }
...
/*      */         }
/*      */       } 
/* 2158 */     } catch (UnsupportedCharsetException ucex) {
/*      */       
/*      */       try {
...
/*      */           }
/*      */         } 
/* 2170 */       } catch (UnsupportedEncodingException ueex) {
...
/* 2188 */     String configuredTimeZoneOnServer = this.serverVariables.get("timezone");
/*      */     
/* 2190 */     if (configuredTimeZoneOnServer == null) {
/* 2191 */       configuredTimeZoneOnServer = this.serverVariables.get("time_zone");
/*      */       
/* 2193 */       if ("SYSTEM".equalsIgnoreCase(configuredTimeZoneOnServer)) {
/* 2194 */         configuredTimeZoneOnServer = this.serverVariables.get("system_time_zone");
/*      */       }
/*      */     } 
/*      */     
...
/*      */         
/*      */         }
/* 2213 */         catch (IllegalArgumentException iae) {
...
/* 2256 */       lowerBound = (long)(lowerBound + bucketSize);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 2300 */     for (; attemptCount < getMaxReconnects() && !connectionGood; attemptCount++) {
/*      */       try {
/* 2302 */         boolean oldAutoCommit; int oldIsolationLevel; boolean oldReadOnly; String oldCatalog; if (this.io != null) {
...
/*      */           try {
/* 2358 */             Thread.sleep((long)timeout * 1000L);
...
/*      */ 
/*      */       
/* 2385 */       Iterator<Statement> statementIter = this.openStatements.values().iterator();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/* 2396 */       Stack<Statement> serverPreparedStatements = null;
/*      */       
/* 2398 */       while (statementIter.hasNext()) {
/* 2399 */         Statement statementObj = statementIter.next();
/*      */         
/* 2401 */         if (statementObj instanceof ServerPreparedStatement) {
/* 2402 */           if (serverPreparedStatements == null) {
/* 2403 */             serverPreparedStatements = new Stack<Statement>();
/*      */           }
/*      */           
...
/*      */     }
/* 2482 */     catch (NumberFormatException nfe) {
...
/*      */       }
/*      */       
/* 2547 */       SQLException chainedEx = SQLError.createSQLException(Messages.getString("Connection.UnableToConnect"), "08001", getExceptionInterceptor());
/*      */ 
/*      */       
...
/*      */ 
/*      */       
/* 2565 */       CacheAdapterFactory<String, PreparedStatement.ParseInfo> cacheFactory = (CacheAdapterFactory<String, PreparedStatement.ParseInfo>)factoryClass.newInstance();
/*      */       
...
/*      */     }
/* 2569 */     catch (ClassNotFoundException e) {
...
/*      */       
/* 2575 */       throw sqlEx;
/* 2576 */     } catch (InstantiationException e) {
...
/*      */     try {
/* 2781 */       if (packet == null) {
/* 2782 */         String encoding = null;
/*      */         
/* 2784 */         if (getUseUnicode()) {
/* 2785 */           encoding = getEncoding();
/*      */         }
/*      */         
/* 2788 */         return this.io.sqlQueryDirect(callingStatement, sql, encoding, null, maxRows, resultSetType, resultSetConcurrency, streamResults, catalog, cachedMetadata);
/*      */       } 
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 2794 */       return this.io.sqlQueryDirect(callingStatement, null, null, packet, maxRows, resultSetType, resultSetConcurrency, streamResults, catalog, cachedMetadata);
/*      */ 
/*      */     
/*      */     }
/* 2798 */     catch (SQLException sqlE) {
/*      */ 
/*      */       
...
/*      */           } 
/* 3007 */         } catch (UnsupportedEncodingException unsupEncEx) {
...
/*      */       try {
/* 3039 */         charsetName = this.indexToJavaCharset.get(Integer.valueOf(charsetIndex));
/*      */         
...
/*      */         }
/*      */       }
/* 3050 */       catch (ArrayIndexOutOfBoundsException outOfBoundsEx) {
...
/*      */       
/*      */       }
/* 3055 */       catch (RuntimeException ex) {
/* 3056 */         SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/* 3145 */     return getMaxBytesPerChar((Integer)null, javaCharsetName);
/*      */   }
/*      */ 
/*      */   
...
/*      */     
/*      */     try {
/* 3158 */       charset = this.indexToCustomMysqlCharset.get(charsetIndex);
/*      */       
/* 3160 */       if (charset == null) charset = CharsetMapping.STATIC_INDEX_TO_MYSQL_CHARSET_MAP.get(charsetIndex);
/*      */ 
/*      */       
...
/*      */ 
/*      */       
/* 3172 */       Integer mblen = this.mysqlCharsetToCustomMblen.get(charset);
/*      */ 
/*      */       
/* 3175 */       if (mblen == null) mblen = CharsetMapping.STATIC_CHARSET_TO_NUM_BYTES_MAP.get(charset); 
/* 3176 */       if (mblen == null) mblen = CharsetMapping.STATIC_4_0_CHARSET_TO_NUM_BYTES_MAP.get(charset);
/*      */       
/* 3178 */       if (mblen != null) return mblen.intValue(); 
/* 3179 */     } catch (SQLException ex) {
/* 3180 */       throw ex;
/* 3181 */     } catch (RuntimeException ex) {
/* 3182 */       SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/* 3213 */     Statement stmt = createStatement();
/*      */     
...
/* 3244 */       String charset = this.indexToCustomMysqlCharset.get(Integer.valueOf(this.io.serverCharsetIndex));
/* 3245 */       if (charset == null) charset = CharsetMapping.STATIC_INDEX_TO_MYSQL_CHARSET_MAP.get(Integer.valueOf(this.io.serverCharsetIndex)); 
/* 3246 */       return (charset != null) ? charset : this.serverVariables.get("character_set_server");
/*      */     } 
/* 3248 */     return this.serverVariables.get("character_set");
/*      */   }
/*      */   
...
/* 3275 */       return this.serverVariables.get(variableName);
/*      */     }
/*      */     
/* 3278 */     return null;
/*      */   }
...
/*      */           
/* 3323 */           if (s != null) {
/* 3324 */             Integer intTI = mapTransIsolationNameToValue.get(s);
/*      */             
/* 3326 */             if (intTI != null) {
/* 3327 */               return intTI.intValue();
/*      */             }
/*      */           } 
/*      */           
...
/* 3379 */       this.typeMap = new HashMap<String, Class<?>>();
/*      */     }
/*      */     
...
/* 3424 */       this.numberOfPreparedExecutes++;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 3429 */       this.numberOfQueriesIssued++;
/*      */     } 
/*      */   }
/*      */   
/*      */   public void incrementNumberOfPrepares() {
/* 3434 */     if (getGatherPerformanceMetrics()) {
/* 3435 */       this.numberOfPrepares++;
/*      */     }
/*      */   }
/*      */   
/*      */   public void incrementNumberOfResultSetsCreated() {
/* 3440 */     if (getGatherPerformanceMetrics()) {
/* 3441 */       this.numberOfResultSetsCreated++;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */       
/* 3560 */       String lowerCaseTables = this.serverVariables.get("lower_case_table_names");
/*      */       
...
/* 3603 */         int sqlMode = 0;
/*      */         
/* 3605 */         String sqlModeAsString = this.serverVariables.get("sql_mode");
/*      */         try {
/* 3607 */           sqlMode = Integer.parseInt(sqlModeAsString);
/* 3608 */         } catch (NumberFormatException nfe) {
/*      */ 
/*      */           
/* 3611 */           sqlMode = 0;
/*      */           
...
/* 3636 */       throw ex;
/* 3637 */     } catch (RuntimeException ex) {
/* 3638 */       SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/* 3686 */       String characterSetResultsOnServerMysql = this.serverVariables.get("jdbc.local.character_set_results");
/*      */       
...
/*      */ 
/*      */         
/* 3692 */         String defaultMetadataCharsetMysql = this.serverVariables.get("character_set_system");
...
/* 3739 */     return ("ON".equalsIgnoreCase(this.serverVariables.get("query_cache_type")) && !"0".equalsIgnoreCase(this.serverVariables.get("query_cache_size")));
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */     try {
/* 3746 */       return Integer.parseInt(this.serverVariables.get(variableName));
/* 3747 */     } catch (NumberFormatException nfe) {
...
/*      */     
/* 3766 */     String initConnectValue = this.serverVariables.get("init_connect");
/*      */     
...
/* 3895 */         if (rs.next()) {
/* 3896 */           return (rs.getInt(1) != 0);
/*      */         }
/* 3898 */       } catch (SQLException ex1) {
...
/* 3988 */     this.usingCachedConfig = false;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 4208 */   public boolean lowerCaseTableNames() { return this.lowerCaseTableNames; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 4219 */       this.statementsUsingMaxRows = new HashMap<Statement, Statement>();
/*      */     }
/*      */     
...
/*      */       } else {
/* 4357 */         synchronized (this.parsedCallableStatementCache) {
...
/* 4443 */     PreparedStatement pStmt = prepareStatement(sql);
/*      */     
...
/* 4563 */     PreparedStatement pStmt = prepareStatement(sql);
/*      */     
...
/* 4577 */     PreparedStatement pStmt = prepareStatement(sql);
/*      */     
...
/*      */             
/* 4622 */             this.eventSink.consumeEvent(new ProfilerEvent((byte)0, "", getCatalog(), getId(), -1, -1, System.currentTimeMillis(), 0L, Constants.MILLIS_I18N, null, this.pointOfOrigin, message));
/*      */           } 
/*      */ 
/*      */ 
/*      */ 
...
/*      */             
/* 4636 */             this.eventSink.consumeEvent(new ProfilerEvent((byte)0, "", getCatalog(), getId(), -1, -1, System.currentTimeMillis(), 0L, Constants.MILLIS_I18N, null, this.pointOfOrigin, message));
/*      */           } 
/*      */         } 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/* 4720 */     this.numberOfQueriesIssued++;
/*      */     
...
/*      */     
/* 4769 */     repartitionHistogram(this.perfMetricsHistCounts, this.perfMetricsHistBreakpoints, (this.shortestQueryTimeMs == Long.MAX_VALUE) ? 0L : this.shortestQueryTimeMs, this.longestQueryTimeMs);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/* 4778 */     repartitionHistogram(this.numTablesMetricsHistCounts, this.numTablesMetricsHistBreakpoints, (this.minimumNumberTablesAccessed == Long.MAX_VALUE) ? 0L : this.minimumNumberTablesAccessed, this.maximumNumberTablesAccessed);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 4810 */         int highestCount = Integer.MIN_VALUE;
/*      */         int i;
/* 4812 */         for (i = 0; i < 20; i++) {
...
/* 4864 */         int highestCount = Integer.MIN_VALUE;
/*      */         int i;
/* 4866 */         for (i = 0; i < 20; i++) {
...
/* 4979 */         IterateBlock<Extension> iter = new IterateBlock<Extension>(this.connectionLifecycleInterceptors.iterator())
/*      */           {
/*      */             void forEach(Extension each) throws SQLException {
...
/*      */       
/*      */       }
/* 5012 */     } catch (SQLException sqlException) {
...
/* 5036 */           IterateBlock<Extension> iter = new IterateBlock<Extension>(this.connectionLifecycleInterceptors.iterator())
/*      */             {
/*      */               void forEach(Extension each) throws SQLException {
/* 5039 */                 if (!((ConnectionLifecycleInterceptor)each).rollback(savepoint)) {
...
/*      */ 
/*      */     
/* 5115 */     execSQL((StatementImpl)null, "rollback", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5239 */       IterateBlock<Extension> iter = new IterateBlock<Extension>(this.connectionLifecycleInterceptors.iterator())
/*      */         {
/*      */           void forEach(Extension each) throws SQLException {
/* 5242 */             if (!((ConnectionLifecycleInterceptor)each).setAutoCommit(autoCommitFlag)) {
...
/* 5282 */           execSQL((StatementImpl)null, autoCommitFlag ? "SET autocommit=1" : "SET autocommit=0", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */         
/*      */         }
/*      */       
/*      */       }
...
/* 5329 */       IterateBlock<Extension> iter = new IterateBlock<Extension>(this.connectionLifecycleInterceptors.iterator())
/*      */         {
/*      */           void forEach(Extension each) throws SQLException {
/* 5332 */             if (!((ConnectionLifecycleInterceptor)each).setCatalog(catalog)) {
...
/*      */     
/* 5368 */     execSQL((StatementImpl)null, query.toString(), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 5428 */       execSQL((StatementImpl)null, "set session transaction " + (readOnlyFlag ? "read only" : "read write"), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 5490 */       List<String> variablesToSet = StringUtils.split(getSessionVariables(), ",", "\"'", "\"'", false);
/*      */ 
/*      */       
/* 5493 */       int numVariablesToSet = variablesToSet.size();
/*      */       
/* 5495 */       Statement stmt = null;
/*      */       
/*      */       try {
/* 5498 */         stmt = getMetadataSafeStatement();
/*      */         
/* 5500 */         for (int i = 0; i < numVariablesToSet; i++) {
/* 5501 */           String variableValuePair = variablesToSet.get(i);
/*      */           
...
/*      */ 
/*      */         
/* 5578 */         execSQL((StatementImpl)null, sql, -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */         
...
/* 5608 */       String currentSqlMode = this.serverVariables.get("sql_mode");
/*      */ 
/*      */       
...
/*      */         
/* 5624 */         execSQL((StatementImpl)null, commandBuf.toString(), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */         
...
/*      */         
/* 5717 */         execSQL((StatementImpl)null, "SET SQL_SELECT_LIMIT=DEFAULT", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */         
...
/* 5864 */       IterateBlock<Extension> iter = new IterateBlock<Extension>(this.connectionLifecycleInterceptors.iterator())
/*      */         {
/*      */           void forEach(Extension each) throws SQLException {
...
/* 5877 */       IterateBlock<Extension> iter = new IterateBlock<Extension>(this.connectionLifecycleInterceptors.iterator())
/*      */         {
/*      */           void forEach(Extension each) throws SQLException {
...
/*      */     
/* 5996 */     checkClosed();
/* 5997 */     final MysqlIO mysqlIo = this.io;
/*      */     
/* 5999 */     executor.execute(new Runnable()
/*      */         {
/*      */           public void run() {
/* 6002 */             ConnectionImpl.this.setSocketTimeout(milliseconds);
/*      */             try {
/* 6004 */               mysqlIo.setSocketTimeout(milliseconds);
/* 6005 */             } catch (SQLException e) {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/ConnectionImpl.class
