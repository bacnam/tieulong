...
/*  61 */       return new ByteArrayInputStream(StringUtils.getBytes(this.charData));
/*     */     }
/*     */     
/*  64 */     return null;
/*     */   }
...
/* 118 */     return position(arg0.getSubString(0L, (int)arg0.length()), arg1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 159 */       bytesOut.write(StringUtils.getBytes(this.charData), 0, (int)(indexToWriteAt - 1L));
/*     */     }
/*     */ 
/*     */     
/* 163 */     return bytesOut;
...
/*     */       try {
/* 252 */         out.write(StringUtils.getBytes(this.charData, (String)null, (String)null, false, (MySQLConnection)null, this.exceptionInterceptor), streamSize, this.charData.length() - streamSize);
/*     */       
/*     */       }
...
/* 281 */     this.charData = new String(charDataBeingWritten);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 299 */     this.charData = null;
/*     */   }
/*     */   
/*     */   public Reader getCharacterStream(long pos, long length) throws SQLException {
/* 303 */     return new StringReader(getSubString(pos, (int)length));
/*     */   }
/*     */ }


/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/Clob.class
