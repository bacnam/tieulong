...
/*  49 */         FailoverConnectionProxy.this.queriesIssuedFailedOver++;
/*     */       }
/*     */       
...
/*     */           
/* 127 */           return invoke(proxy, method, args, this.failedOver);
...
/*     */       }  }
/* 136 */      return invoke(proxy, method, args, this.failedOver);
/*     */   }
/*     */   
...
/* 167 */       this.primaryHostPortSpec = this.hostList.remove(0);
/*     */     }
/*     */     
...
/* 183 */       Iterator<Map.Entry<String, ConnectionImpl>> iter = this.liveConnections.entrySet().iterator();
/*     */       
...
/*     */       
/* 218 */       return true;
/* 219 */     }  if (this.queriesBeforeRetryMaster != 0L && this.queriesIssuedFailedOver >= this.queriesBeforeRetryMaster) {
/* 220 */       return true;
/*     */     }
/*     */     
/* 223 */     return false;
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/FailoverConnectionProxy.class
