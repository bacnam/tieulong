...
/* 532 */     if (type == null) {
/* 533 */       throw SQLError.createSQLException("Type parameter can not be null", "S1009", getExceptionInterceptor());
/*     */     }
/*     */ 
/*     */     
/* 537 */     if (type.equals(Struct.class))
/* 538 */       throw new SQLFeatureNotSupportedException(); 
/* 539 */     if (type.equals(RowId.class))
/* 540 */       return (T)getRowId(columnIndex); 
/* 541 */     if (type.equals(NClob.class))
/* 542 */       return (T)getNClob(columnIndex); 
/* 543 */     if (type.equals(SQLXML.class)) {
/* 544 */       return (T)getSQLXML(columnIndex);
/*     */     }
/*     */     
/* 547 */     return super.getObject(columnIndex, type);
/*     */   }
/*     */ }


/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/JDBC4ResultSet.class
