...
/*     */   
/*     */   static {
/* 152 */     HashMap<String, Integer> tempNumBytesMap = new HashMap<String, Integer>();
...
/*     */     
/* 195 */     tempNumBytesMap = new HashMap<String, Integer>();
...
/*     */ 
/*     */     
/* 292 */     HashMap<String, List<VersionedStringProperty>> javaToMysqlMap = new HashMap<String, List<VersionedStringProperty>>();
/*     */     
...
/*     */ 
/*     */     
/* 298 */     HashMap<String, String> mysqlToJavaMap = new HashMap<String, String>();
/*     */     
/* 300 */     Set<String> keySet = JAVA_TO_MYSQL_CHARSET_MAP.keySet();
/* 301 */     Iterator<String> javaCharsets = keySet.iterator();
/* 302 */     while (javaCharsets.hasNext()) {
/* 303 */       String javaEncodingName = javaCharsets.next();
/* 304 */       List<VersionedStringProperty> mysqlEncodingList = JAVA_TO_MYSQL_CHARSET_MAP.get(javaEncodingName);
/*     */       
/* 306 */       Iterator<VersionedStringProperty> mysqlEncodings = mysqlEncodingList.iterator();
/*     */       
/* 308 */       String mysqlEncodingName = null;
/*     */       
/* 310 */       while (mysqlEncodings.hasNext()) {
/* 311 */         VersionedStringProperty mysqlProp = mysqlEncodings.next();
...
/*     */ 
/*     */     
/* 326 */     TreeMap<String, List<VersionedStringProperty>> ucMap = new TreeMap<String, List<VersionedStringProperty>>(String.CASE_INSENSITIVE_ORDER);
/* 327 */     Iterator<String> javaNamesKeys = JAVA_TO_MYSQL_CHARSET_MAP.keySet().iterator();
/* 328 */     while (javaNamesKeys.hasNext()) {
/* 329 */       String key = javaNamesKeys.next();
...
/*     */ 
/*     */     
/* 338 */     HashMap<String, String> tempMapMulti = new HashMap<String, String>();
/*     */     
...
/*     */     
/* 379 */     Collation[] collation = new Collation[255];
...
/* 507 */     collation[128] = new Collation(128, "ucs2_unicode_ci", "ucs2");
/* 508 */     collation[129] = new Collation(129, "ucs2_icelandic_ci", "ucs2");
/* 509 */     collation[130] = new Collation(130, "ucs2_latvian_ci", "ucs2");
/* 510 */     collation[131] = new Collation(131, "ucs2_romanian_ci", "ucs2");
/* 511 */     collation[132] = new Collation(132, "ucs2_slovenian_ci", "ucs2");
/* 512 */     collation[133] = new Collation(133, "ucs2_polish_ci", "ucs2");
/* 513 */     collation[134] = new Collation(134, "ucs2_estonian_ci", "ucs2");
/* 514 */     collation[135] = new Collation(135, "ucs2_spanish_ci", "ucs2");
/* 515 */     collation[136] = new Collation(136, "ucs2_swedish_ci", "ucs2");
/* 516 */     collation[137] = new Collation(137, "ucs2_turkish_ci", "ucs2");
/* 517 */     collation[138] = new Collation(138, "ucs2_czech_ci", "ucs2");
/* 518 */     collation[139] = new Collation(139, "ucs2_danish_ci", "ucs2");
/* 519 */     collation[140] = new Collation(140, "ucs2_lithuanian_ci", "ucs2");
/* 520 */     collation[141] = new Collation(141, "ucs2_slovak_ci", "ucs2");
/* 521 */     collation[142] = new Collation(142, "ucs2_spanish2_ci", "ucs2");
/* 522 */     collation[143] = new Collation(143, "ucs2_roman_ci", "ucs2");
/* 523 */     collation[144] = new Collation(144, "ucs2_persian_ci", "ucs2");
/* 524 */     collation[145] = new Collation(145, "ucs2_esperanto_ci", "ucs2");
/* 525 */     collation[146] = new Collation(146, "ucs2_hungarian_ci", "ucs2");
/* 526 */     collation[147] = new Collation(147, "ucs2_sinhala_ci", "ucs2");
/* 527 */     collation[148] = new Collation(148, "ucs2_german2_ci", "ucs2");
/* 528 */     collation[149] = new Collation(149, "ucs2_croatian_ci", "ucs2");
/* 529 */     collation[150] = new Collation(150, "ucs2_unicode_520_ci", "ucs2");
/* 530 */     collation[151] = new Collation(151, "ucs2_vietnamese_ci", "ucs2");
/* 531 */     collation[152] = new Collation(152, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 532 */     collation[153] = new Collation(153, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 533 */     collation[154] = new Collation(154, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 534 */     collation[155] = new Collation(155, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 535 */     collation[156] = new Collation(156, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 536 */     collation[157] = new Collation(157, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 537 */     collation[158] = new Collation(158, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 538 */     collation[159] = new Collation(159, "ucs2_general_mysql500_ci", "ucs2");
/* 539 */     collation[160] = new Collation(160, "utf32_unicode_ci", "utf32");
/* 540 */     collation[161] = new Collation(161, "utf32_icelandic_ci", "utf32");
/* 541 */     collation[162] = new Collation(162, "utf32_latvian_ci", "utf32");
/* 542 */     collation[163] = new Collation(163, "utf32_romanian_ci", "utf32");
/* 543 */     collation[164] = new Collation(164, "utf32_slovenian_ci", "utf32");
/* 544 */     collation[165] = new Collation(165, "utf32_polish_ci", "utf32");
/* 545 */     collation[166] = new Collation(166, "utf32_estonian_ci", "utf32");
/* 546 */     collation[167] = new Collation(167, "utf32_spanish_ci", "utf32");
/* 547 */     collation[168] = new Collation(168, "utf32_swedish_ci", "utf32");
/* 548 */     collation[169] = new Collation(169, "utf32_turkish_ci", "utf32");
/* 549 */     collation[170] = new Collation(170, "utf32_czech_ci", "utf32");
/* 550 */     collation[171] = new Collation(171, "utf32_danish_ci", "utf32");
/* 551 */     collation[172] = new Collation(172, "utf32_lithuanian_ci", "utf32");
/* 552 */     collation[173] = new Collation(173, "utf32_slovak_ci", "utf32");
/* 553 */     collation[174] = new Collation(174, "utf32_spanish2_ci", "utf32");
/* 554 */     collation[175] = new Collation(175, "utf32_roman_ci", "utf32");
/* 555 */     collation[176] = new Collation(176, "utf32_persian_ci", "utf32");
/* 556 */     collation[177] = new Collation(177, "utf32_esperanto_ci", "utf32");
/* 557 */     collation[178] = new Collation(178, "utf32_hungarian_ci", "utf32");
/* 558 */     collation[179] = new Collation(179, "utf32_sinhala_ci", "utf32");
/* 559 */     collation[180] = new Collation(180, "utf32_german2_ci", "utf32");
/* 560 */     collation[181] = new Collation(181, "utf32_croatian_ci", "utf32");
/* 561 */     collation[182] = new Collation(182, "utf32_unicode_520_ci", "utf32");
/* 562 */     collation[183] = new Collation(183, "utf32_vietnamese_ci", "utf32");
/* 563 */     collation[184] = new Collation(184, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 564 */     collation[185] = new Collation(185, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 565 */     collation[186] = new Collation(186, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 566 */     collation[187] = new Collation(187, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 567 */     collation[188] = new Collation(188, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 568 */     collation[189] = new Collation(189, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 569 */     collation[190] = new Collation(190, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 570 */     collation[191] = new Collation(191, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 571 */     collation[192] = new Collation(192, "utf8_unicode_ci", "utf8");
/* 572 */     collation[193] = new Collation(193, "utf8_icelandic_ci", "utf8");
/* 573 */     collation[194] = new Collation(194, "utf8_latvian_ci", "utf8");
/* 574 */     collation[195] = new Collation(195, "utf8_romanian_ci", "utf8");
/* 575 */     collation[196] = new Collation(196, "utf8_slovenian_ci", "utf8");
/* 576 */     collation[197] = new Collation(197, "utf8_polish_ci", "utf8");
/* 577 */     collation[198] = new Collation(198, "utf8_estonian_ci", "utf8");
/* 578 */     collation[199] = new Collation(199, "utf8_spanish_ci", "utf8");
/* 579 */     collation[200] = new Collation(200, "utf8_swedish_ci", "utf8");
/* 580 */     collation[201] = new Collation(201, "utf8_turkish_ci", "utf8");
/* 581 */     collation[202] = new Collation(202, "utf8_czech_ci", "utf8");
/* 582 */     collation[203] = new Collation(203, "utf8_danish_ci", "utf8");
/* 583 */     collation[204] = new Collation(204, "utf8_lithuanian_ci", "utf8");
/* 584 */     collation[205] = new Collation(205, "utf8_slovak_ci", "utf8");
/* 585 */     collation[206] = new Collation(206, "utf8_spanish2_ci", "utf8");
/* 586 */     collation[207] = new Collation(207, "utf8_roman_ci", "utf8");
/* 587 */     collation[208] = new Collation(208, "utf8_persian_ci", "utf8");
/* 588 */     collation[209] = new Collation(209, "utf8_esperanto_ci", "utf8");
/* 589 */     collation[210] = new Collation(210, "utf8_hungarian_ci", "utf8");
/* 590 */     collation[211] = new Collation(211, "utf8_sinhala_ci", "utf8");
/* 591 */     collation[212] = new Collation(212, "utf8_german2_ci", "utf8");
/* 592 */     collation[213] = new Collation(213, "utf8_croatian_ci", "utf8");
/* 593 */     collation[214] = new Collation(214, "utf8_unicode_520_ci", "utf8");
/* 594 */     collation[215] = new Collation(215, "utf8_vietnamese_ci", "utf8");
/* 595 */     collation[216] = new Collation(216, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 596 */     collation[217] = new Collation(217, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 597 */     collation[218] = new Collation(218, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 598 */     collation[219] = new Collation(219, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 599 */     collation[220] = new Collation(220, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 600 */     collation[221] = new Collation(221, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 601 */     collation[222] = new Collation(222, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 602 */     collation[223] = new Collation(223, "utf8_general_mysql500_ci", "utf8");
/* 603 */     collation[224] = new Collation(224, "utf8mb4_unicode_ci", "utf8mb4");
/* 604 */     collation[225] = new Collation(225, "utf8mb4_icelandic_ci", "utf8mb4");
/* 605 */     collation[226] = new Collation(226, "utf8mb4_latvian_ci", "utf8mb4");
/* 606 */     collation[227] = new Collation(227, "utf8mb4_romanian_ci", "utf8mb4");
/* 607 */     collation[228] = new Collation(228, "utf8mb4_slovenian_ci", "utf8mb4");
/* 608 */     collation[229] = new Collation(229, "utf8mb4_polish_ci", "utf8mb4");
/* 609 */     collation[230] = new Collation(230, "utf8mb4_estonian_ci", "utf8mb4");
/* 610 */     collation[231] = new Collation(231, "utf8mb4_spanish_ci", "utf8mb4");
/* 611 */     collation[232] = new Collation(232, "utf8mb4_swedish_ci", "utf8mb4");
/* 612 */     collation[233] = new Collation(233, "utf8mb4_turkish_ci", "utf8mb4");
/* 613 */     collation[234] = new Collation(234, "utf8mb4_czech_ci", "utf8mb4");
/* 614 */     collation[235] = new Collation(235, "utf8mb4_danish_ci", "utf8mb4");
/* 615 */     collation[236] = new Collation(236, "utf8mb4_lithuanian_ci", "utf8mb4");
/* 616 */     collation[237] = new Collation(237, "utf8mb4_slovak_ci", "utf8mb4");
/* 617 */     collation[238] = new Collation(238, "utf8mb4_spanish2_ci", "utf8mb4");
/* 618 */     collation[239] = new Collation(239, "utf8mb4_roman_ci", "utf8mb4");
/* 619 */     collation[240] = new Collation(240, "utf8mb4_persian_ci", "utf8mb4");
/* 620 */     collation[241] = new Collation(241, "utf8mb4_esperanto_ci", "utf8mb4");
/* 621 */     collation[242] = new Collation(242, "utf8mb4_hungarian_ci", "utf8mb4");
/* 622 */     collation[243] = new Collation(243, "utf8mb4_sinhala_ci", "utf8mb4");
/* 623 */     collation[244] = new Collation(244, "utf8mb4_german2_ci", "utf8mb4");
/* 624 */     collation[245] = new Collation(245, "utf8mb4_croatian_ci", "utf8mb4");
/* 625 */     collation[246] = new Collation(246, "utf8mb4_unicode_520_ci", "utf8mb4");
/* 626 */     collation[247] = new Collation(247, "utf8mb4_vietnamese_ci", "utf8mb4");
/* 627 */     collation[248] = new Collation(248, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 628 */     collation[249] = new Collation(249, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 629 */     collation[250] = new Collation(250, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 630 */     collation[251] = new Collation(251, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 631 */     collation[252] = new Collation(252, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 632 */     collation[253] = new Collation(253, "latin1_german1_ci", "latin1", "ISO8859_1");
/* 633 */     collation[254] = new Collation(254, "utf8mb3_general_cs", "utf8");
/*     */     
/* 635 */     INDEX_TO_COLLATION = new String[255];
/* 636 */     INDEX_TO_CHARSET = new String[255];
/* 637 */     Map<Integer, String> indexToMysqlCharset = new HashMap<Integer, String>();
/* 638 */     Map<String, Integer> indexMap = new TreeMap<String, Integer>(String.CASE_INSENSITIVE_ORDER);
/*     */     int i;
/* 640 */     for (i = 1; i < 255; i++) {
...
/*     */       
/* 645 */       if (INDEX_TO_CHARSET[i] != null) indexMap.put(INDEX_TO_CHARSET[i], Integer.valueOf(i));
/*     */     
/*     */     } 
/*     */     
/* 649 */     for (i = 1; i < 255; i++) {
...
/* 652 */       if (INDEX_TO_CHARSET[i] == null) throw new RuntimeException("Assertion failure: No mapping from charset index " + i + " to a Java character set");
/*     */     
/*     */     } 
...
/*     */     
/* 658 */     Map<String, String> tempMap = new HashMap<String, String>();
/*     */     
...
/*     */     try {
/* 693 */       List<VersionedStringProperty> mysqlEncodings = JAVA_UC_TO_MYSQL_CHARSET_MAP.get(javaEncodingUC);
/*     */       
/* 695 */       if (mysqlEncodings != null) {
/* 696 */         Iterator<VersionedStringProperty> iter = mysqlEncodings.iterator();
/*     */         
/* 698 */         VersionedStringProperty versionedProp = null;
/*     */         
/* 700 */         while (iter.hasNext()) {
/* 701 */           VersionedStringProperty propToCheck = iter.next();
/*     */           
/* 703 */           if (conn == null)
/*     */           {
/*     */             
...
/*     */ 
/*     */           
/* 717 */           if (propToCheck.isOkayForVersion(conn)) {
...
/* 737 */       SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/* 766 */       String str = conn.getServerVariable("character_set_results");
/* 767 */       if (str != null) {
/* 768 */         String str1 = conn.getJavaEncodingForMysqlEncoding(str);
/* 769 */         if (str1 != null) {
/* 770 */           return str1;
/*     */         }
/*     */       } 
...
/*     */     
/* 807 */     String errorMessageEncodingMysql = ERROR_MESSAGE_FILE_TO_MYSQL_CHARSET_MAP.get(errorMessageFile);
/*     */     
...
/*     */     
/* 844 */     List<String> mappings = StringUtils.split(javaToMysqlConfig, ",", true);
/* 845 */     if (mappings == null) throw new RuntimeException("Missing/corrupt entry for \"" + configKey + "\" in Charsets.properties.");
/*     */     
/* 847 */     Iterator<String> mappingsIter = mappings.iterator();
/* 848 */     while (mappingsIter.hasNext()) {
/* 849 */       String aMapping = mappingsIter.next();
/* 850 */       List<String> parsedPair = StringUtils.split(aMapping, "=", true);
...
/*     */     
/* 865 */     List<String> mappings = StringUtils.split(javaToMysqlConfig, ",", true);
/* 866 */     if (mappings == null) throw new RuntimeException("Missing/corrupt entry for \"" + configKey + "\" in Charsets.properties.");
/*     */     
/* 868 */     Iterator<String> mappingsIter = mappings.iterator();
/* 869 */     while (mappingsIter.hasNext()) {
/* 870 */       String aMapping = mappingsIter.next();
/* 871 */       List<String> parsedPair = StringUtils.split(aMapping, "=", true);
...
/*     */       
/* 877 */       List<VersionedStringProperty> versionedProperties = mapToPopulate.get(key);
/*     */       
/* 879 */       if (versionedProperties == null) {
/* 880 */         versionedProperties = new ArrayList<VersionedStringProperty>();
...
/* 889 */         versionedProperties = mapToPopulate.get(keyUc);
/*     */         
/* 891 */         if (versionedProperties == null) {
/* 892 */           versionedProperties = new ArrayList<VersionedStringProperty>();
...
/*     */     }
/*     */     
/* 906 */     Integer asInt = MYSQL_ENCODING_NAME_TO_CHARSET_INDEX_MAP.get(name);
/*     */     
/* 908 */     if (asInt == null) {
/* 909 */       return 0;
/*     */     }
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/CharsetMapping.class
