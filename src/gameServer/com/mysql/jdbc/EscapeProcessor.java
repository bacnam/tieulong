...
/*     */   
/*     */   static {
/*  52 */     Map<String, String> tempMap = new HashMap<String, String>();
/*     */     
...
/*     */     
/*  75 */     tempMap = new HashMap<String, String>(JDBC_CONVERT_TO_MYSQL_TYPE_MAP);
/*     */     
...
/*     */ 
/*     */               
/* 409 */               Time inServerTimezone = TimeUtil.changeTimezone(conn, sessionCalendar, (Calendar)null, toBeAdjusted, sessionCalendar.getTimeZone(), conn.getServerTimezoneTZ(), false);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */                   
/* 578 */                   Timestamp inServerTimezone = TimeUtil.changeTimezone(conn, sessionCalendar, (Calendar)null, toBeAdjusted, sessionCalendar.getTimeZone(), conn.getServerTimezoneTZ(), false);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*     */       }
/* 629 */       catch (IllegalArgumentException illegalArgumentException) {
...
/* 727 */       newType = JDBC_CONVERT_TO_MYSQL_TYPE_MAP.get(trimmedType.toUpperCase(Locale.ENGLISH));
/*     */     } else {
/*     */       
/* 730 */       newType = JDBC_NO_CONVERT_TO_MYSQL_EXPRESSION_MAP.get(trimmedType.toUpperCase(Locale.ENGLISH));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/EscapeProcessor.class
