...
/*    */ {
/* 39 */   private static final Map<MySQLConnection, ProfilerEventHandler> CONNECTIONS_TO_SINKS = new HashMap<MySQLConnection, ProfilerEventHandler>();
/*    */   
...
/* 54 */     ProfilerEventHandler handler = CONNECTIONS_TO_SINKS.get(conn);
/*    */ 
/*    */     
/* 57 */     if (handler == null) {
...
/* 72 */     ProfilerEventHandler handler = CONNECTIONS_TO_SINKS.remove(conn);
/*    */     
/* 74 */     if (handler != null) {
/* 75 */       handler.destroy();
/*    */     }
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/ProfilerEventHandlerFactory.class
