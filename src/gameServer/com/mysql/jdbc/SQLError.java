...
/*  152 */     if (Util.isJdbc4()) {
/*      */       try {
/*  154 */         JDBC_4_COMMUNICATIONS_EXCEPTION_CTOR = Class.forName("com.mysql.jdbc.exceptions.jdbc4.CommunicationsException").getConstructor(new Class[] { MySQLConnection.class, long.class, long.class, Exception.class });
/*      */ 
/*      */       
/*      */       }
...
/*      */     } 
/*      */   }
/*  176 */   private static Map<String, String> sqlStateMessages = new HashMap<String, String>(); static {
...
/*      */ 
/*      */     
/*  248 */     mysqlToSqlState = new Hashtable<Integer, String>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*  414 */     mysqlToSql99State = new HashMap<Integer, String>();
/*      */     
...
/*  816 */     TreeMap<Integer, Integer> allErrorNumbers = new TreeMap<Integer, Integer>();
/*  817 */     Map<Object, String> mysqlErrorNumbersToNames = new HashMap<Object, String>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  867 */     return sqlStateMessages.get(stateCode);
/*      */   }
/*      */   
...
/*  874 */       return mysqlToSql99State.get(err);
/*      */     }
/*      */     
/*  877 */     return "HY000";
/*      */   }
...
/*  900 */       return mysqlToSqlState.get(err);
/*      */     }
/*      */     
/*  903 */     return "S1000";
/*      */   }
...
/*  923 */     return createSQLException(message, interceptor, (Connection)null);
/*      */   }
...
/*  940 */     return createSQLException(message, sqlState, cause, interceptor, (Connection)null);
/*      */   }
/*      */   
...
/*      */     try {
/*  993 */       SQLException sqlEx = null;
/*      */       
/*  995 */       if (sqlState != null) {
/*  996 */         if (sqlState.startsWith("08")) {
/*  997 */           if (isTransient) {
/*  998 */             if (!Util.isJdbc4()) {
/*  999 */               MySQLTransientConnectionException mySQLTransientConnectionException = new MySQLTransientConnectionException(message, sqlState, vendorErrorCode);
/*      */             } else {
/*      */               
/* 1002 */               sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLTransientConnectionException", new Class[] { String.class, String.class, int.class }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */             
/*      */             }
/*      */ 
...
/* 1011 */             MySQLNonTransientConnectionException mySQLNonTransientConnectionException = new MySQLNonTransientConnectionException(message, sqlState, vendorErrorCode);
/*      */           } else {
/*      */             
/* 1014 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException", new Class[] { String.class, String.class, int.class }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */           
/*      */           }
/*      */ 
...
/* 1023 */             MySQLDataException mySQLDataException = new MySQLDataException(message, sqlState, vendorErrorCode);
/*      */           } else {
/*      */             
/* 1026 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLDataException", new Class[] { String.class, String.class, int.class }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */           
/*      */           }
/*      */ 
...
/* 1037 */             MySQLIntegrityConstraintViolationException mySQLIntegrityConstraintViolationException = new MySQLIntegrityConstraintViolationException(message, sqlState, vendorErrorCode);
/*      */           } else {
/*      */             
/* 1040 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException", new Class[] { String.class, String.class, int.class }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */           
/*      */           }
/*      */ 
...
/* 1050 */             MySQLSyntaxErrorException mySQLSyntaxErrorException = new MySQLSyntaxErrorException(message, sqlState, vendorErrorCode);
/*      */           } else {
/*      */             
/* 1053 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException", new Class[] { String.class, String.class, int.class }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) }, interceptor);
/*      */ 
/*      */           
/*      */           }
/*      */ 
...
/* 1062 */             MySQLTransactionRollbackException mySQLTransactionRollbackException = new MySQLTransactionRollbackException(message, sqlState, vendorErrorCode);
/*      */           } else {
/*      */             
/* 1065 */             sqlEx = (SQLException)Util.getInstance("com.mysql.jdbc.exceptions.jdbc4.MySQLTransactionRollbackException", new Class[] { String.class, String.class, int.class }, new Object[] { message, sqlState, Integer.valueOf(vendorErrorCode) }, interceptor);
/*      */           
/*      */           }
/*      */ 
/*      */         
...
/*      */         } 
/*      */       } else {
/* 1077 */         sqlEx = new SQLException(message, sqlState, vendorErrorCode);
/*      */       } 
/*      */       
...
/*      */       
/* 1088 */       return sqlEx;
/* 1089 */     } catch (SQLException sqlEx) {
/* 1090 */       SQLException unexpectedEx = new SQLException("Unable to create correct SQLException class instance, error class/codes may be incorrect. Reason: " + Util.stackTraceToString(sqlEx), "S1000");
/*      */ 
/*      */ 
/*      */ 
/*      */       
...
/*      */       
/*      */       }
/* 1277 */       else if (underlyingException instanceof java.net.BindException) {
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/SQLError.class
