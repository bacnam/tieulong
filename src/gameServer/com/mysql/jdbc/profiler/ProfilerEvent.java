...
/* 396 */     buf[pos++] = (byte)(int)(l & 0xFFL);
/* 397 */     buf[pos++] = (byte)(int)(l >>> 8L);
/* 398 */     buf[pos++] = (byte)(int)(l >>> 16L);
/* 399 */     buf[pos++] = (byte)(int)(l >>> 24L);
/* 400 */     buf[pos++] = (byte)(int)(l >>> 32L);
/* 401 */     buf[pos++] = (byte)(int)(l >>> 40L);
/* 402 */     buf[pos++] = (byte)(int)(l >>> 48L);
/* 403 */     buf[pos++] = (byte)(int)(l >>> 56L);
/*     */     
/* 405 */     return pos;
/*     */   }
/*     */   
...
/* 423 */     return (buf[pos++] & 0xFF) | (buf[pos++] & 0xFF) << 8L | (buf[pos++] & 0xFF) << 16L | (buf[pos++] & 0xFF) << 24L | (buf[pos++] & 0xFF) << 32L | (buf[pos++] & 0xFF) << 40L | (buf[pos++] & 0xFF) << 48L | (buf[pos++] & 0xFF) << 56L;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/profiler/ProfilerEvent.class
