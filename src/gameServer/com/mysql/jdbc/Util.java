...
/*     */     Method method;
/*     */     try {
/*  57 */       method = System.class.getMethod("nanoTime", (Class[])null);
...
/*     */     } 
/*     */     
/*  64 */     systemNanoTimeMethod = method;
/*     */   }
/*     */   
...
/*     */     int i;
/* 156 */     for (i = 0; i < seed.length(); i++) {
/* 157 */       seed1 = (seed1 * 3L + seed2) % max;
/* 158 */       seed2 = (seed1 + seed2 + 33L) % max;
/* 159 */       double d1 = seed1 / max;
/* 160 */       byte b1 = (byte)(int)Math.floor(d1 * 31.0D + 64.0D);
/* 161 */       chars[i] = (char)b1;
/*     */     } 
/*     */     
...
/*     */     
/* 169 */     for (i = 0; i < seed.length(); i++) {
/* 170 */       chars[i] = (char)(chars[i] ^ (char)b);
/*     */     }
/*     */     
...
/* 245 */         nr ^= ((nr & 0x3FL) + nr2) * tmp + (nr << 8L);
/* 246 */         nr2 += tmp;
/*     */       } 
/*     */     } 
/* 249 */     return nr & 0x7FFFFFFFL;
/*     */   }
/*     */   
/*     */   private static RandStructcture randomInit(long seed1, long seed2) {
/* 253 */     enclosingInstance.getClass(); RandStructcture randStruct = new RandStructcture();
/*     */     
...
/*     */     try {
/* 450 */       Class<?> networkInterfaceClass = Class.forName("java.net.NetworkInterface"); return 
/*     */         
/* 452 */         (networkInterfaceClass.getMethod("getByName", (Class[])null).invoke(networkInterfaceClass, new Object[] { hostname }) != null);
/*     */     }
...
/*     */         continue;
/*     */       } 
/* 550 */       if (value1 instanceof Short) {
/* 551 */         diffMap.put(key, Short.valueOf((short)(((Short)value2).shortValue() - ((Short)value1).shortValue()))); continue;
/*     */       } 
/* 553 */       if (value1 instanceof Integer) {
/* 554 */         diffMap.put(key, Integer.valueOf(((Integer)value2).intValue() - ((Integer)value1).intValue()));
/*     */         continue;
/*     */       } 
/* 557 */       if (value1 instanceof Long) {
/* 558 */         diffMap.put(key, Long.valueOf(((Long)value2).longValue() - ((Long)value1).longValue()));
/*     */         continue;
/*     */       } 
/* 561 */       if (value1 instanceof Float) {
/* 562 */         diffMap.put(key, Float.valueOf(((Float)value2).floatValue() - ((Float)value1).floatValue())); continue;
/*     */       } 
/* 564 */       if (value1 instanceof Double) {
/* 565 */         diffMap.put(key, Double.valueOf((((Double)value2).shortValue() - ((Double)value1).shortValue())));
/*     */         continue;
/*     */       } 
/* 568 */       if (value1 instanceof BigDecimal) {
/* 569 */         diffMap.put(key, ((BigDecimal)value2).subtract((BigDecimal)value1)); continue;
/*     */       } 
/* 571 */       if (value1 instanceof BigInteger) {
...
/*     */     
/* 585 */     List<String> interceptorsToCreate = StringUtils.split(extensionClassNames, ",", true);
/*     */ 
/*     */     
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/Util.class
