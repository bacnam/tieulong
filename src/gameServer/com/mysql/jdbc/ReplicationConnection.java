...
/*      */     
/*  104 */     this.masterConnection = (Connection)driver.connect(masterUrl.toString(), masterProperties);
/*      */     
/*  106 */     this.slavesConnection = (Connection)driver.connect(slaveUrl.toString(), slaveProperties);
/*      */     
...
/*  147 */     Statement stmt = this.currentConnection.createStatement();
...
/*  160 */     Statement stmt = this.currentConnection.createStatement(resultSetType, resultSetConcurrency);
/*      */ 
/*      */     
...
/*  176 */     Statement stmt = this.currentConnection.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability);
/*      */ 
/*      */     
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/ReplicationConnection.class
