...
/*     */       try {
/* 132 */         javaName = CharsetMapping.MYSQL_TO_JAVA_CHARSET_MAP.get(mysqlName);
/* 133 */       } catch (RuntimeException ex) {
/* 134 */         SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/*     */         }
/*     */         
/* 567 */         collationName = field.getCollation();
/*     */         
...
/*     */     try {
/* 856 */       return Util.cast(iface, this);
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/ResultSetMetaData.class
