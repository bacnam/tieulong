...
/*  46 */   private static final Map<String, SingleByteCharsetConverter> CONVERTER_MAP = new HashMap<String, SingleByteCharsetConverter>();
/*     */   
...
/*  83 */     SingleByteCharsetConverter instance = CONVERTER_MAP.get(encodingName);
/*     */ 
/*     */     
/*  86 */     if (instance == null) {
...
/* 110 */       SQLException sqlEx = SQLError.createSQLException(ex.toString(), "S1009", (ExceptionInterceptor)null);
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/SingleByteCharsetConverter.class
