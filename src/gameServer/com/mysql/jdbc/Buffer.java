...
/*     */     
/* 367 */     return b[this.position++] & 0xFFL | (b[this.position++] & 0xFFL) << 8L | (b[this.position++] & 0xFF) << 16L | (b[this.position++] & 0xFF) << 24L;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 385 */     return (b[this.position++] & 0xFF) | (b[this.position++] & 0xFF) << 8L | (b[this.position++] & 0xFF) << 16L | (b[this.position++] & 0xFF) << 24L | (b[this.position++] & 0xFF) << 32L | (b[this.position++] & 0xFF) << 40L | (b[this.position++] & 0xFF) << 48L | (b[this.position++] & 0xFF) << 56L;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 639 */     b[this.position++] = (byte)(int)(i & 0xFFL);
/* 640 */     b[this.position++] = (byte)(int)(i >>> 8L);
/* 641 */     b[this.position++] = (byte)(int)(i >>> 16L);
/* 642 */     b[this.position++] = (byte)(int)(i >>> 24L);
/*     */   }
/*     */ 
/*     */   
...
/* 657 */     b[this.position++] = (byte)(int)(i & 0xFFL);
/* 658 */     b[this.position++] = (byte)(int)(i >>> 8L);
/* 659 */     b[this.position++] = (byte)(int)(i >>> 16L);
/* 660 */     b[this.position++] = (byte)(int)(i >>> 24L);
/* 661 */     b[this.position++] = (byte)(int)(i >>> 32L);
/* 662 */     b[this.position++] = (byte)(int)(i >>> 40L);
/* 663 */     b[this.position++] = (byte)(int)(i >>> 48L);
/* 664 */     b[this.position++] = (byte)(int)(i >>> 56L);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /Users/bacnam/Projects/TieuLongProject/gameserver/gameServer.jar!/com/mysql/jdbc/Buffer.class
