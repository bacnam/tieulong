...
byte b = this._byteBuffer.get();
if (b >= 0) {
cbuf[i++] = (char)b; continue;
} 
if (i < off_plus_len - 1) {
int code = read2(b);
remaining = this._byteBuffer.remaining();
if (code < 65536) {
cbuf[i++] = (char)code; continue;
}  if (code <= 1114111) {
cbuf[i++] = (char)((code - 65536 >> 10) + 55296);
cbuf[i++] = (char)((code - 65536 & 0x3FF) + 56320); continue;
} 
...
byte b = this._byteBuffer.get();
if (b >= 0) {
dest.append((char)b); continue;
} 
int code = read2(b);
if (code < 65536) {
dest.append((char)code); continue;
}  if (code <= 1114111) {
dest.append((char)((code - 65536 >> 10) + 55296));
dest.append((char)((code - 65536 & 0x3FF) + 56320)); continue;
} 
throw new CharConversionException("Cannot convert U+" + Integer.toHexString(code) + " to char (code greater than U+10FFFF)");
} 
}
