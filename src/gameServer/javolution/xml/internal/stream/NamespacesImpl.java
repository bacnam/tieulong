...
this._namespacesCount[this._nesting] = this._namespacesCount[this._nesting] + 1; if (this._namespacesCount[this._nesting] + 1 >= this._prefixes.length) {
resizePrefixStack();
}
}
...
public NamespacesImpl() { this._prefixesTmp = new CharArray[this._prefixes.length];

this._namespacesTmp = new CharArray[this._prefixes.length]; this._prefixes[0] = this._defaultNsPrefix; this._namespaces[0] = this._nullNsURI; this._prefixes[1] = this._xml; this._namespaces[1] = this._xmlURI;
this._prefixes[2] = this._xmlns;
this._namespaces[2] = this._xmlnsURI;
this._namespacesCount[0] = 3; } void pop() { if (this._namespacesCount[--this._nesting] <= this._defaultNamespaceIndex) {
