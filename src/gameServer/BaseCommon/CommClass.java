...
String filePath;
String str1;
switch ((str1 = protocol).hashCode()) { case 104987: if (!str1.equals("jar")) {
continue;
}
...
int i;
File[] arrayOfFile1;
for (i = (arrayOfFile1 = dirfiles).length, b = 0; b < i; ) { File file = arrayOfFile1[b];
...
List<Class<?>> classes = new ArrayList<>();
if (!dir.exists())
return classes;  byte b; int i;
File[] arrayOfFile;
for (i = (arrayOfFile = dir.listFiles()).length, b = 0; b < i; ) { File f = arrayOfFile[b];
if (f.isDirectory()) {
...
Field[] fields = object.getClass().getDeclaredFields(); byte b; int i; Field[] arrayOfField1;
