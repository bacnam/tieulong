...
if (i <= 0 || j <= 0)
return;  for (int k = 0; k < rectangle.width; k += i) {
...
stringBuffer.append(paramArrayOfString[b]); stringBuffer.append(paramString);
...
for (byte b = 0; b < paramArrayOfString.length; ) { vector.add(paramArrayOfString[b]); b++; }
return vector;
}
