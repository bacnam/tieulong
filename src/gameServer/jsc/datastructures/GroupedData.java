...
this.minValue = paramArrayOfdouble[0]; this.maxValue = paramArrayOfdouble[0];
...
arrayOfDouble[b1] = arrayOfDouble1[b]; b1++;
} 
...
for (byte b1 = 0; b1 < getSize(str); ) { stringBuffer.append(" " + arrayOfDouble[b1]); b1++; }
