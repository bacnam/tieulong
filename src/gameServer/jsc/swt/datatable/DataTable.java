...
double d;
paramCalculatorVariables.setRowIndex(b); try {
...
public void clear() {
if (getCellSelectionEnabled()) { clearSelectedCells(); }
else if (getColumnSelectionAllowed()) { clearSelectedColumns(); }
else if (getRowSelectionAllowed()) { clearSelectedRows(); }
...
Object object = getValueAt(b, paramInt);
if (object != null) {
Number number; String str = object.toString(); 
try { number = this.realFormat.parse(str); }
catch (ParseException parseException) { return; }
...
if (object != null) {
Number number; String str = object.toString(); 
try { number = this.integerFormat.parse(str); }
catch (ParseException parseException) { return; }
...
if (i < 0)
return;  this.dataModel.insertColumn(++i);
}
...
case 3:
pasteCells(Table.copiedData); break;
case 2: pasteColumns(); break;
case 1: pasteRows();
break;
} 
}
...
if (k < 1)
return;  int m = paramDataMatrix.getColumnCount();

int n = getColumnCount();
int i1 = j + m;
if (i1 > n) {
for (byte b = 1; b <= i1 - n; ) { addColumn(); b++; }

}

byte b1;

for (b1 = 1; b1 <= k; ) { addRow(); b1++; }
...
if (i < 1)
return;  for (byte b = 0; b < Table.copiedData.getColumnCount(); b++) {
...
int i = getSelectedRow();
if (i < 0)
return;  int j = Table.copiedData.getColumnCount();

int k = Table.copiedData.getRowCount();
if (k < 1)
return;  for (byte b = 0; b < k; b++) {
...
}  if (paramBoolean && !bool) { this.dataModel.removeRow(m); }
else if (!paramBoolean && bool) { this.dataModel.removeRow(m); }
...
case 6:
if (d1 <= 0.0D)
break;  d = Maths.log10(d1);

case 4:
if (d1 <= 0.0D)
break;  d = Math.sqrt(1.0D / d1);
...
default:
setValueAt(new Double(d), b, i); break;
}  continue;
}  return i;
}
...
if (i == 10) { this.this$0.setColumnNameEdited(true); }
else if (i == 27) { this.this$0.setColumnNameEdited(false); }
else if (i == 18) { this.this$0.columnNameEditor.setVisible(false); }
else
{ return; }
...
return;  if (this.this$0.getColumnClass(this.this$0.clickedColumn) == ((DataTable.class$java$lang$String == null) ? (DataTable.class$java$lang$String = DataTable.class$("java.lang.String")) : DataTable.class$java$lang$String)) {
...
super((JTextField)this$0.realField); this.this$0 = this$0;
}
...
super((JTextField)this$0.integerField); this.this$0 = this$0;
}
...
super((JTextField)this$0.illegalCharsField); this.this$0 = this$0;
}
