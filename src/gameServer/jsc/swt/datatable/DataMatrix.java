...
this.columnClasses.addElement(paramClass); Vector vector;
this.columnData.addElement(vector = new Vector(paramInt1));
for (byte b1 = 0; b1 < paramInt1; ) { vector.addElement(null); b1++; }
...
for (byte b = 0; b < this.rowCount; ) { vector.addElement(null); b++; }
...
convertStringToDouble(paramInt); convertDoubleToInteger(paramInt);
}
