...
buttonGroup1.add(jRadioButtonMenuItem1); buttonGroup1.add(jRadioButtonMenuItem2); buttonGroup1.add(jRadioButtonMenuItem3);
...
if (vector.isEmpty())
return;  NameDialogue nameDialogue = new NameDialogue(DataWindow.this.parent, "Calculation dialogue", "Select column to do calculation on", vector, 0);

String[] arrayOfString = nameDialogue.showNames();
if (arrayOfString == null)
return;  String str = param1ActionEvent.getActionCommand();
int i = -1;
if (str.equals("Rank...")) {
...
public ClearAction(String param1String) { super(param1String); } public void actionPerformed(ActionEvent param1ActionEvent) {
...
public InsertColumnAction(String param1String, Icon param1Icon) { super(param1String, param1Icon); } public void actionPerformed(ActionEvent param1ActionEvent) {
DataWindow.this.dataTable.addColumn();
} }

class InsertRowAction extends AbstractAction { private final DataWindow this$0;

public InsertRowAction(String param1String, Icon param1Icon) { super(param1String, param1Icon); } public void actionPerformed(ActionEvent param1ActionEvent) {
...
public PasteAction(String param1String, Icon param1Icon) { super(param1String, param1Icon); } public void actionPerformed(ActionEvent param1ActionEvent) {
DataWindow.this.dataTable.paste();
} }

class PasteClipboardAction extends AbstractAction { private final DataWindow this$0;

public PasteClipboardAction(String param1String) { super(param1String); } public void actionPerformed(ActionEvent param1ActionEvent) {
...
if (vector1.isEmpty())
return;  NameDialogue nameDialogue = new NameDialogue(DataWindow.this.parent, "Recode dialogue", "Select column to recode", vector1, 0);
...
public ResetColumnAction(String param1String) { super(param1String); } public void actionPerformed(ActionEvent param1ActionEvent) {
DataWindow.this.dataTable.resetColumnOrder();
} }

class SelectAllAction extends AbstractAction { private final DataWindow this$0;

public SelectAllAction(String param1String) { super(param1String); } public void actionPerformed(ActionEvent param1ActionEvent) {
...
public SelectNoneAction(String param1String) { super(param1String); } public void actionPerformed(ActionEvent param1ActionEvent) {
DataWindow.this.dataTable.clearSelection();
} }
...
if (vector.isEmpty())
return;  NameDialogue nameDialogue = new NameDialogue(DataWindow.this.parent, "Sort dialogue", "Select column to sort with", vector, 0);
...
String[] arrayOfString = nameDialogue.showNames();
if (arrayOfString == null)
return;  DataWindow.this.dataTable.sortRows(arrayOfString[0], jRadioButton1.isSelected());
} }
...
if (vector.isEmpty())
return;  NameDialogue nameDialogue = new NameDialogue(DataWindow.this.parent, "Subset dialogue", "Select column to choose subset with", vector, 0);
