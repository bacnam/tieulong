...
this.count[0] = 0; byte b1;
for (b1 = 1; b1 < i; ) { this.count[b1] = this.count[b1 - 1] + this.ns[b1 - 1]; b1++; }
...
this.R[b1] = 0.0D;
for (byte b = 0; b < this.ns[b1]; ) { this.R[b1] = this.R[b1] + this.ranks[b2++]; b++; }

} 

for (b1 = 0; b1 < i; ) { this.R[b1] = this.R[b1] / this.ns[b1]; b1++; }
...
for (byte b = 0; b < this.valueCount; ) { stringBuffer.append(" " + this.ns[b]); b++; }
