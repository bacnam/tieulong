...
i = this.sampleSize; d3 = this.markedItemsCount;
} else {
i = this.markedItemsCount; d3 = this.sampleSize;
} 
for (byte b = 1; b <= i; b++) {
...
for (byte b = 0; b < i; ) { arrayOfInt[b] = (int)hypergeometric.random(); b++; }
