...
this.minX = paramSpline.getMinX(); this.maxX = paramSpline.getMaxX();
...
SplineCurve(SplineShape this$0) { this.this$0 = this$0; } public double function(double param1Double) {
return this.this$0.spline.splint(param1Double);
} }

class SplineMean implements Function { SplineMean(SplineShape this$0) { this.this$0 = this$0; } private final SplineShape this$0; public double function(double param1Double) {
...
double d1 = 2.0D;
double d2 = 3.0D;
Beta beta = new Beta(d1, d2); byte b1;
for (b1 = 0; b1 < b2; b1++)
{
