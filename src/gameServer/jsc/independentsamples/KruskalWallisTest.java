...
for (byte b = 0; b < this.ns[b1]; ) { this.R[b1] = this.R[b1] + rank.getRank(b2++); b++; }

} 

for (b1 = 0; b1 < this.k; ) { this.R[b1] = this.R[b1] / this.ns[b1]; b1++; }
...
arrayOfInt[0] = 0; byte b1;
for (b1 = 1; b1 < this.k; ) { arrayOfInt[b1] = arrayOfInt[b1 - 1] + this.ns[b1 - 1]; b1++; }
...
for (byte b = 0; b < this.ns[b1]; ) { arrayOfDouble2[b1] = arrayOfDouble2[b1] + arrayOfDouble1[b2++]; b++; }

} 

for (b1 = 0; b1 < this.k; ) { arrayOfDouble2[b1] = arrayOfDouble2[b1] / this.ns[b1]; b1++; }
