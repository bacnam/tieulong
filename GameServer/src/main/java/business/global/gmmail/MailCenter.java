...
public class MailCenter {
    private static MailCenter instance = new MailCenter();
    public List<GlobalMailBO> allBOs;
    public HashMap<Long, List<PlayerMailBO>> offLineMailCached;
    protected BaseMutexObject m_mutex;
