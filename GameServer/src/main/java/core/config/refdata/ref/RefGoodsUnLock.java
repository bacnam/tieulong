...
for (i = (arrayOfGoodsUnLockType = ConstEnum.GoodsUnLockType.values()).length, b = 0; b < i; ) { ConstEnum.GoodsUnLockType type = arrayOfGoodsUnLockType[b];
typeValue.put(type, Lists.newArrayList()); b++; }
