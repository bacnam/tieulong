...
this.id = 0L;
this.pid = 0L;
this.lastRefreshTime = new ArrayList<>(25); int i;
for (i = 0; i < 25; i++) {
...
} public List<Integer> getLastRefreshTimeAll() { return new ArrayList<>(this.lastRefreshTime); }
public void setLastRefreshTimeAll(int value) { for (int i = 0; i < this.lastRefreshTime.size(); ) { this.lastRefreshTime.set(i, Integer.valueOf(value)); i++; }
} public void saveLastRefreshTimeAll(int value) { setLastRefreshTimeAll(value); saveAll(); } public int getLastRefreshTime(int index) {
...
} public List<Integer> getFreeRefreshTimesAll() { return new ArrayList<>(this.freeRefreshTimes); }
public void setFreeRefreshTimesAll(int value) { for (int i = 0; i < this.freeRefreshTimes.size(); ) { this.freeRefreshTimes.set(i, Integer.valueOf(value)); i++; }
} public void saveFreeRefreshTimesAll(int value) { setFreeRefreshTimesAll(value); saveAll(); } public int getFreeRefreshTimes(int index) {
...
} public List<Integer> getPaidRefreshTimesAll() { return new ArrayList<>(this.paidRefreshTimes); }
public void setPaidRefreshTimesAll(int value) { for (int i = 0; i < this.paidRefreshTimes.size(); ) { this.paidRefreshTimes.set(i, Integer.valueOf(value)); i++; }
} public void savePaidRefreshTimesAll(int value) { setPaidRefreshTimesAll(value); saveAll(); } public int getPaidRefreshTimes(int index) {
...
} public List<Integer> getBuyTimesAll() { return new ArrayList<>(this.buyTimes); }
public void setBuyTimesAll(int value) { for (int i = 0; i < this.buyTimes.size(); ) { this.buyTimes.set(i, Integer.valueOf(value)); i++; }
} public void saveBuyTimesAll(int value) { setBuyTimesAll(value); saveAll(); } public int getBuyTimes(int index) {
...
} public List<Integer> getFlushIconAll() { return new ArrayList<>(this.flushIcon); }
public void setFlushIconAll(int value) { for (int i = 0; i < this.flushIcon.size(); ) { this.flushIcon.set(i, Integer.valueOf(value)); i++; }
} public void saveFlushIconAll(int value) { setFlushIconAll(value); saveAll(); } public int getFlushIcon(int index) {
