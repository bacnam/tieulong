...
this.id = 0L;
this.pid = 0L;
this.value = new ArrayList<>(60); int i;
for (i = 0; i < 60; i++) {
...
} public List<Integer> getValueAll() { return new ArrayList<>(this.value); }
public void setValueAll(int value) { for (int i = 0; i < this.value.size(); ) { this.value.set(i, Integer.valueOf(value)); i++; }
} public void saveValueAll(int value) { setValueAll(value); saveAll(); } public int getValue(int index) {
...
} public List<Integer> getUseItemTimesAll() { return new ArrayList<>(this.useItemTimes); }
public void setUseItemTimesAll(int value) { for (int i = 0; i < this.useItemTimes.size(); ) { this.useItemTimes.set(i, Integer.valueOf(value)); i++; }
} public void saveUseItemTimesAll(int value) { setUseItemTimesAll(value); saveAll(); } public int getUseItemTimes(int index) {
