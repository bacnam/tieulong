...
public class LongnvwarpuppetBO
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `longnvwarpuppet` (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',`pid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家ID',`guildId` bigint(20) NOT NULL DEFAULT '0' COMMENT '公会ID',`puppetId` int(11) NOT NULL DEFAULT '0' COMMENT '傀儡ID',`applyTime` int(11) NOT NULL DEFAULT '0' COMMENT '申请时间',KEY `pid` (`pid`),PRIMARY KEY (`id`)) COMMENT='玩家傀儡信息'  DEFAULT CHARSET=utf8 AUTO_INCREMENT=" + (
    ...
    public void getFromResultSet(ResultSet rs, List<LongnvwarpuppetBO> list) throws Exception {
        list.add(new LongnvwarpuppetBO(rs));
    }
