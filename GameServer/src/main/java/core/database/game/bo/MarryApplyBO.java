...
public class MarryApplyBO
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `marry_apply` (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',`pid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家id',`from_pid` bigint(20) NOT NULL DEFAULT '0' COMMENT '来自玩家id',`apply_time` int(11) NOT NULL DEFAULT '0' COMMENT '申请时间',PRIMARY KEY (`id`)) COMMENT='婚恋系统'  DEFAULT CHARSET=utf8 AUTO_INCREMENT=" + (
