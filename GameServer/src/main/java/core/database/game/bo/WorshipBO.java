...
public class WorshipBO
    ...
    public WorshipBO() {
        this.id = 0L;
        this.pid = 0L;
        this.worshipTimes = new ArrayList<>(20);
        int i;
        for (i = 0; i < 20; i++) {
    ...
    public List<Integer> getWorshipTimesAll() {
        return new ArrayList<>(this.worshipTimes);
    }

    public void setWorshipTimesAll(int value) {
        for (int i = 0; i < this.worshipTimes.size(); ) {
            this.worshipTimes.set(i, Integer.valueOf(value));
            i++;
        }
    }

    public void saveWorshipTimesAll(int value) {
        setWorshipTimesAll(value);
        saveAll();
    }

    public int getWorshipTimes(int index) {
    ...
    public List<Integer> getBeWorshipTimesAll() {
        return new ArrayList<>(this.beWorshipTimes);
    }

    public void setBeWorshipTimesAll(int value) {
        for (int i = 0; i < this.beWorshipTimes.size(); ) {
            this.beWorshipTimes.set(i, Integer.valueOf(value));
            i++;
        }
    }

    public void saveBeWorshipTimesAll(int value) {
        setBeWorshipTimesAll(value);
        saveAll();
    }

    public int getBeWorshipTimes(int index) {
