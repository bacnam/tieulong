...
this.id = 0L;
this.pid = 0L;
this.instanceMaxLevel = new ArrayList<>(10); int i;
for (i = 0; i < 10; i++) {
...
} public List<Integer> getInstanceMaxLevelAll() { return new ArrayList<>(this.instanceMaxLevel); }
public void setInstanceMaxLevelAll(int value) { for (int i = 0; i < this.instanceMaxLevel.size(); ) { this.instanceMaxLevel.set(i, Integer.valueOf(value)); i++; }
} public void saveInstanceMaxLevelAll(int value) { setInstanceMaxLevelAll(value); saveAll(); } public int getInstanceMaxLevel(int index) {
...
} public List<Integer> getChallengTimesAll() { return new ArrayList<>(this.challengTimes); }
public void setChallengTimesAll(int value) { for (int i = 0; i < this.challengTimes.size(); ) { this.challengTimes.set(i, Integer.valueOf(value)); i++; }
} public void saveChallengTimesAll(int value) { setChallengTimesAll(value); saveAll(); } public int getChallengTimes(int index) {
