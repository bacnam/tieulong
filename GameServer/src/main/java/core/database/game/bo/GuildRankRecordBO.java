...
this.owner = rs.getLong(4);
this.value = rs.getLong(5);
this.updateTime = rs.getInt(6);
this.ext1 = rs.getLong(7);
this.ext2 = rs.getLong(8);
this.ext3 = rs.getLong(9);
this.ext4 = rs.getString(10);
this.ext5 = rs.getString(11);
}

public void getFromResultSet(ResultSet rs, List<GuildRankRecordBO> list) throws Exception {
list.add(new GuildRankRecordBO(rs));
}
...
return "`id`, `type`, `guildid`, `owner`, `value`, `updateTime`, `ext1`, `ext2`, `ext3`, `ext4`, `ext5`";
}

public String getTableName() {
return "`guild_rank_record`";
}
...
String sql = "CREATE TABLE IF NOT EXISTS `guild_rank_record` (`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',`type` int(11) NOT NULL DEFAULT '0' COMMENT '排行榜类型',`guildid` bigint(20) NOT NULL DEFAULT '0' COMMENT '帮派id',`owner` bigint(20) NOT NULL DEFAULT '0' COMMENT '所属者id',`value` bigint(20) NOT NULL DEFAULT '0' COMMENT '值',`updateTime` int(11) NOT NULL DEFAULT '0' COMMENT '更新时间',`ext1` bigint(20) NOT NULL DEFAULT '0' COMMENT '扩展字段1',`ext2` bigint(20) NOT NULL DEFAULT '0' COMMENT '扩展字段2',`ext3` bigint(20) NOT NULL DEFAULT '0' COMMENT '扩展字段3',`ext4` varchar(200) NOT NULL DEFAULT '' COMMENT '扩展字段4',`ext5` varchar(200) NOT NULL DEFAULT '' COMMENT '扩展字段5',PRIMARY KEY (`id`)) COMMENT='排行表'  DEFAULT CHARSET=utf8 AUTO_INCREMENT=" + (
