...
} public List<Integer> getIndexLastTimeAll() { return new ArrayList<>(this.indexLastTime); }
public void setIndexLastTimeAll(int value) { for (int i = 0; i < this.indexLastTime.size(); ) { this.indexLastTime.set(i, Integer.valueOf(value)); i++; }
} public void saveIndexLastTimeAll(int value) { setIndexLastTimeAll(value); saveAll(); } public int getIndexLastTime(int index) {
