...
} public List<Integer> getLastFetchPrivateTimeAll() { return new ArrayList<>(this.lastFetchPrivateTime); }
public void setLastFetchPrivateTimeAll(int value) { for (int i = 0; i < this.lastFetchPrivateTime.size(); ) { this.lastFetchPrivateTime.set(i, Integer.valueOf(value)); i++; }
} public void saveLastFetchPrivateTimeAll(int value) { setLastFetchPrivateTimeAll(value); saveAll(); } public int getLastFetchPrivateTime(int index) {
