...
public class GuildLogBO
    ...
    public List<String> getParamAll() {
        return new ArrayList<>(this.param);
    }

    public void setParamAll(String value) {
        for (int i = 0; i < this.param.size(); ) {
            this.param.set(i, value);
            i++;
        }
    }

    public void saveParamAll(String value) {
        setParamAll(value);
        saveAll();
    }
