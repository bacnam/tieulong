...
public class GafferConfigurator implements GroovyObject {
    ...
    protected void informContextOfURLUsedForConfiguration(URL url) {
        CallSite[] arrayOfCallSite = $getCallSiteArray();
        arrayOfCallSite[0].call(ConfigurationWatchListUtil.class, this.context, url);
    }
    ...
    public void run(URL url) {
        ...
        if (!__$stMC && !BytecodeInterface8.disabledStandardMetaClass()) {
            ...
            arrayOfCallSite[1].callCurrent(this, url);
        }
    ...
    public void run(File file) {
        CallSite[] arrayOfCallSite = $getCallSiteArray();
        arrayOfCallSite[4].callCurrent(this, arrayOfCallSite[5].call(arrayOfCallSite[6].call(file)));
        arrayOfCallSite[7].callCurrent(this, arrayOfCallSite[8].callGetProperty(file));
    }

    public void run(String dslText) {
        CallSite[] arrayOfCallSite = $getCallSiteArray();
        Binding binding = (Binding) ScriptBytecodeAdapter.castToType(arrayOfCallSite[9].callConstructor(Binding.class), Binding.class);
        ...
        if (!__$stMC && !BytecodeInterface8.disabledStandardMetaClass()) {
            arrayOfCallSite[15].call(configuration, importCustomizer());
        } else {
            arrayOfCallSite[13].call(configuration, arrayOfCallSite[14].callCurrent(this));
        }
        ...
        _run_closure1 _run_closure1 = new _run_closure1(this, this, dslScript);
        ScriptBytecodeAdapter.setProperty(_run_closure1, null, arrayOfCallSite[29].callGroovyObjectGetProperty(dslScript.get()), "getDeclaredOrigin");
    ...
    protected ImportCustomizer importCustomizer() {
        CallSite[] arrayOfCallSite = $getCallSiteArray();
        Object customizer = arrayOfCallSite[31].callConstructor(ImportCustomizer.class);
