...
CallSite[] arrayOfCallSite = $getCallSiteArray(); List list = ScriptBytecodeAdapter.createList(new Object[0]); MetaClass metaClass = $getStaticMetaClass();

Object object = SYNTHETIC_LOCAL_VARIABLE_1;
}
public String getLabel() {
CallSite[] arrayOfCallSite = $getCallSiteArray(); return "component";
...
public void methodMissing(String name, Object args) { CallSite[] arrayOfCallSite = $getCallSiteArray(); NestingType nestingType = (NestingType)ShortTypeHandling.castToEnum(arrayOfCallSite[10].call(PropertyUtil.class, this.component, name), NestingType.class);
...
String str = subComponentName; ScriptBytecodeAdapter.setProperty(str, null, subComponent, "name");
} 
if (subComponent instanceof ch.qos.logback.core.spi.ContextAware) {
Object object1 = arrayOfCallSite[40].callGroovyObjectGetProperty(this); ScriptBytecodeAdapter.setProperty(object1, null, subComponent, "context");
} 
...
Object object1 = arrayOfCallSite[43].callGroovyObjectGetProperty(this); ScriptBytecodeAdapter.setGroovyObjectProperty(object1, ComponentDelegate.class, subDelegate, "context");
arrayOfCallSite[44].callCurrent(this, subComponent);
ComponentDelegate componentDelegate1 = subDelegate; ScriptBytecodeAdapter.setGroovyObjectProperty(componentDelegate1, ComponentDelegate.class, (GroovyObject)closure, "delegate");
Object object2 = arrayOfCallSite[45].callGetProperty(Closure.class); ScriptBytecodeAdapter.setGroovyObjectProperty(object2, ComponentDelegate.class, (GroovyObject)closure, "resolveStrategy");
...
String k;
Iterator iterator;
for (arrayOfCallSite = $getCallSiteArray(), k = null, iterator = (Iterator)ScriptBytecodeAdapter.castToType(arrayOfCallSite[53].call(this.fieldsToCascade), Iterator.class); iterator.hasNext(); ) { k = ShortTypeHandling.castToString(iterator.next());
Object object = ScriptBytecodeAdapter.getGroovyObjectProperty(ComponentDelegate.class, this, ShortTypeHandling.castToString(new GStringImpl(new Object[] { k }, new String[] { "", "" }))); ScriptBytecodeAdapter.setProperty(object, null, arrayOfCallSite[54].callGroovyObjectGetProperty(subDelegate), ShortTypeHandling.castToString(new GStringImpl(new Object[] { k }, new String[] { "", "" }))); }

}

public void injectParent(Object subComponent) {
CallSite[] arrayOfCallSite = $getCallSiteArray(); if (DefaultTypeTransformation.booleanUnbox(arrayOfCallSite[55].call(subComponent, "parent"))) {
Object object = this.component; ScriptBytecodeAdapter.setProperty(object, null, subComponent, "parent");
} 
}

public void propertyMissing(String name, Object value) {
CallSite[] arrayOfCallSite = $getCallSiteArray(); NestingType nestingType = (NestingType)ShortTypeHandling.castToEnum(arrayOfCallSite[56].call(PropertyUtil.class, this.component, name), NestingType.class);
...
CallSite[] arrayOfCallSite = $getCallSiteArray(); if (DefaultTypeTransformation.booleanUnbox(arrayOfCallSite[88].call(this.component, "name"))) {
