...
this.max = Integer.MIN_VALUE; byte b;
...
clearData();
for (b = 0; b < paramArrayOfint.length; ) { addValue(paramArrayOfint[b]); b++; }
...
for (byte b = 0; b < paramArrayOfint.length; ) { addValue(paramArrayOfint[b]); b++; }
...
this.freq = new int[this.k];
this.n = 0;
for (byte b = 0; b < this.k; ) { this.freq[b] = paramArrayOfint[b]; this.n += paramArrayOfint[b]; b++; }
...
this.n = 0;
for (byte b = 0; b < this.k; ) { this.freq[b] = 0; b++; }
