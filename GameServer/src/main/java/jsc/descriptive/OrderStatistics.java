...
public final class OrderStatistics
    ...
    public OrderStatistics(double[] paramArrayOfdouble) {
        ...
        if (this.n == 1) {
            this.lowerQuartile = paramArrayOfdouble[0];
            this.upperQuartile = paramArrayOfdouble[0];
            this.median = paramArrayOfdouble[0];
        } else if (this.n == 2) {
            ...
            this.lowerQuartile = paramArrayOfdouble[0];
            this.upperQuartile = paramArrayOfdouble[1];
            this.median = (paramArrayOfdouble[0] + paramArrayOfdouble[1]) / 2.0D;
