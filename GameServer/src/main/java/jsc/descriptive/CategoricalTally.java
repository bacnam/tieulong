...
public class CategoricalTally
    ...
    public CategoricalTally(String paramString, String[] paramArrayOfString) {
        ...
        byte b;
        for (b = 0; b < this.numberOfBins; ) {
            this.freq[b] = 0;
            b++;
        }
        for (b = 0; b < paramArrayOfString.length; ) {
            addValue(paramArrayOfString[b]);
            b++;
        }
    ...
    public CategoricalTally(String paramString, String[] paramArrayOfString1, String[] paramArrayOfString2) {
        ...
        this.labels = (Vector) new CaseInsensitiveVector(this.numberOfBins);
        byte b;
        for (b = 0; b < this.numberOfBins; ) {
            this.labels.add(paramArrayOfString1[b]);
            b++;
        }
        ...
        for (b = 0; b < paramArrayOfString2.length; ) {
            addValue(paramArrayOfString2[b]);
            b++;
        }
    ...
    public CategoricalTally(String paramString, String[] paramArrayOfString, int[] paramArrayOfint) {
        ...
        byte b;
        for (b = 0; b < this.numberOfBins; ) {
            this.labels.add(paramArrayOfString[b]);
            b++;
        }
