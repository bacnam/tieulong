...
if (this.n < 2)
throw new IllegalArgumentException("Less than two data values.");  byte b;
for (b = 0; b < this.n; ) { d += paramArrayOfdouble[b]; b++; }
this.mean = d / this.n;
d = 0.0D;
for (b = 0; b < this.n; ) { d += (paramArrayOfdouble[b] - this.mean) * (paramArrayOfdouble[b] - this.mean); b++; }
...
meanVar2.addValue(62.7D); meanVar2.addValue(59.3D); meanVar2.addValue(68.2D);
...
meanVar4.addValue(7.000002D); meanVar4.addValue(7.000003D); meanVar4.addValue(7.000004D);
