...
public abstract class AbstractMathFunction {
    ...
    private void check_syntax(Vector paramVector) throws MathFunctionException {
        ...
        for (byte b3 = 1; b3 < k; b3++) {
            ...
            switch (m) {
                ...
                case 1:
                    if (bool)
                        throw new MathFunctionException("Missing operand or argument after " + getTokenFromCode(code.code));
                case 0:
                case 3:
                    if (i == 3 || i == 0 || i == 5) {
    ...
    public String getLegalCharacters() {
        ...
        byte b;
        for (b = 0; b < getNumberOfTokens(); ) {
            stringBuffer.append(getToken(b));
            b++;
        }
        for (b = 0; b < this.clv.getNumberOfVariables(); ) {
            stringBuffer.append(this.clv.getVariableName(b));
            b++;
        }
    ...
    private void initialize() {
        ...
        this.eval_count = 0L;
        this.nVarFound = 0;
        for (byte b = 0; b < this.clv.getNumberOfVariables(); ) {
            this.var_flag[b] = false;
            b++;
        }
    ...
    public double parse(String paramString) throws MathFunctionException {
        ...
        for (byte b = 0; b < this.clv.getNumberOfVariables(); ) {
            if (this.var_flag[b]) this.nVarFound++;
            b++;
        }
    ...
    private class Code {
        ...
        Code(AbstractMathFunction this$0, int param1Int1, int param1Int2, double param1Double) {
            this.this$0 = this$0;
            this.code = param1Int1;
            this.type = param1Int2;
            this.constant = param1Double;
        }
    }
    ...
    class ConstantMathFunction
        ...
        public String getVariableName(int param1Int) {
            return "";
        }

        public double getVariableValue(int param1Int) {
            return 0.0D;
        }
    }
}
