...
public class ContingencyTable2x2
    ...
    static class TwoByTwoMatrix {
        ...
        TwoByTwoMatrix(int param1Int1, int param1Int2, int param1Int3, int param1Int4) {
            this.A[0][0] = param1Int1;
            this.A[0][1] = param1Int2;
            this.A[1][0] = param1Int3;
            this.A[1][1] = param1Int4;
        }
