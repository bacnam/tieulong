...
String str = getProperty(paramString); 
try { return (new Double(str)).doubleValue(); }
catch (NumberFormatException numberFormatException) { return paramDouble; }
...
String str = getProperty(paramString); 
try { return (new Integer(str)).intValue(); }
catch (NumberFormatException numberFormatException) { return paramInt; }
...
String str = getProperty(paramString); 
try { return (new Long(str)).longValue(); }
catch (NumberFormatException numberFormatException) { return paramLong; }
