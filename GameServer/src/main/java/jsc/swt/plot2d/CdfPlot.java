...
try { return this.F.cdf(paramDouble); }
catch (IllegalArgumentException illegalArgumentException) { return Double.NaN; }
...
for (byte b = 0; b < c; ) { arrayOfDouble[b] = beta.random(); b++; }
