...
import jsc.swt.virtualgraphics.*;
...
public class PlotPanel
    ...
    public void addComponent(Component paramComponent, VRectangle paramVRectangle) {
        add(paramComponent);
        this.componentBounds.add(paramVRectangle);
    }
    ...
    public void addObjects(PlotObject[] paramArrayOfPlotObject) {
        ...
        for (byte b = 0; b < i; ) {
            this.objects.add(paramArrayOfPlotObject[b]);
            b++;
        }
        repaint();
    }
    ...
    class ZoomKeyListener extends KeyAdapter {
        private final PlotPanel this$0;

        ZoomKeyListener(PlotPanel this$0) {
            this.this$0 = this$0;
        }
    ...
    class ZoomMotionListener extends MouseMotionAdapter {
        private final PlotPanel this$0;

        ZoomMotionListener(PlotPanel this$0) {
            this.this$0 = this$0;
        }
        ...
        public void mouseDragged(MouseEvent param1MouseEvent) {
            if (SwingUtilities.isRightMouseButton(param1MouseEvent) || param1MouseEvent.isShiftDown())
                return;
            VPoint vPoint = this.this$0.pixelToVirtual(param1MouseEvent.getPoint());
            this.this$0.removeObject(this.this$0.zoomBoxObject);
