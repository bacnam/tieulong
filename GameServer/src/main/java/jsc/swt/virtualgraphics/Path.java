...
public class Path
    ...
    public boolean contains(double paramDouble1, double paramDouble2) {
        return this.path.contains(paramDouble1, paramDouble2);
    }

    public boolean contains(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4) {
        return this.path.contains(paramDouble1, paramDouble2, paramDouble3, paramDouble4);
    }

    public boolean contains(Point2D paramPoint2D) {
        return this.path.contains(paramPoint2D);
    }

    public boolean contains(Rectangle2D paramRectangle2D) {
        return this.path.contains(paramRectangle2D);
    }
    ...
    public PathIterator getPathIterator(AffineTransform paramAffineTransform) {
        return this.path.getPathIterator(paramAffineTransform);
    }

    public PathIterator getPathIterator(AffineTransform paramAffineTransform, double paramDouble) {
        return this.path.getPathIterator(paramAffineTransform, paramDouble);
    }

    public boolean intersects(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4) {
        return this.path.intersects(paramDouble1, paramDouble2, paramDouble3, paramDouble4);
    }
