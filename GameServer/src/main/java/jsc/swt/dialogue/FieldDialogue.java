...
this.panel.addComponent(paramJLabel, paramComponent, paramInt, 0); this.dialog.pack();
}

public void addField(String paramString, JTextField paramJTextField, int paramInt) {
this.panel.addField(paramString, paramJTextField, paramInt, 0); this.dialog.pack();
}

public void addField(String paramString, JTextField paramJTextField, int paramInt, char paramChar) {
this.panel.addField(paramString, paramJTextField, paramInt, 0, paramChar); this.dialog.pack();
}

public void addField(JLabel paramJLabel1, JTextField paramJTextField, JLabel paramJLabel2, int paramInt) {
this.panel.addField(paramJLabel1, paramJTextField, paramJLabel2, paramInt, 0); this.dialog.pack();
}

public void addField(JLabel paramJLabel1, JTextField paramJTextField, JLabel paramJLabel2, int paramInt, char paramChar) {
this.panel.addField(paramJLabel1, paramJTextField, paramJLabel2, paramInt, 0, paramChar); this.dialog.pack();
}

public void addToggleButton(JToggleButton paramJToggleButton, int paramInt, char paramChar) {
this.panel.addToggleButton(paramJToggleButton, paramInt, 0, paramChar); this.dialog.pack();
}
}
