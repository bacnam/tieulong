...
public class StatisticalDocument
    ...
    public void bold(String paramString) {
        bold();
        add(paramString);
        unbold();
    }
    ...
    public void italic(String paramString) {
        italic();
        add(paramString);
        unitalic();
    }
    ...
    public void underline(String paramString) {
        underline();
        add(paramString);
        ununderline();
    }
    ...
    public void subscript(String paramString) {
        subscript();
        add(paramString);
        unsubscript();
    }
    ...
    public void superscript(String paramString) {
        superscript();
        add(paramString);
        unsuperscript();
    }
    ...
    public void setFontSize(int paramInt) {
        StyleConstants.setFontSize(this.attributes, paramInt);
    }
    ...
    public void setFontFamily(String paramString) {
        StyleConstants.setFontFamily(this.attributes, paramString);
    }
