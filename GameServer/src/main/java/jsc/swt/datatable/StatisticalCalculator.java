...
gridBagConstraints.gridx = 0; gridBagConstraints.gridy = 0; gridBagConstraints.gridwidth = 1; gridBagConstraints.gridheight = 2;
...
String[] arrayOfString1 = { "+", "-", "*", "/", "^", "%", "<", "<=", "=", ">", ">=", "~=", "|", "&", "~", "(", ")", " ", "pi", "e" }; byte b;
...
gridBagConstraints.gridx = 1; gridBagConstraints.gridy = 0; gridBagConstraints.gridwidth = 1; gridBagConstraints.gridheight = 1;
...
gridBagConstraints.gridx = 2; gridBagConstraints.gridy = 0; gridBagConstraints.gridwidth = 1; gridBagConstraints.gridheight = 2;
...
gridBagConstraints.gridx = 1; gridBagConstraints.gridy = 1; gridBagConstraints.gridwidth = 1; gridBagConstraints.gridheight = 1;
...
public void addActionListener(ActionListener param1ActionListener) { this.this$0.expression.addActionListener(param1ActionListener); }
public Component getEditorComponent() { return (Component)this.this$0.expression; } public Object getItem() {
return this.this$0.expression.getText();
}
public void removeActionListener(ActionListener param1ActionListener) { this.this$0.expression.removeActionListener(param1ActionListener); } public void selectAll() {
