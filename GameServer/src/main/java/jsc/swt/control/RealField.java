...
public class RealField
    ...
    protected class RealNumberDocument extends PlainDocument {
        ...
        protected RealNumberDocument(RealField this$0) {
            this.this$0 = this$0;
        }
        ...
        public void insertString(int param1Int, String param1String, AttributeSet param1AttributeSet) throws BadLocationException {
            ...
            for (byte b2 = 0; b2 < arrayOfChar2.length; b2++) {
                ...
                } else if (c == '-' && param1Int == 0 && getText(0, 1).charAt(0) != '-') {
                    arrayOfChar2[b1++] = c;
                } else if (c == '-' && getText(param1Int - 1, 1).toUpperCase().charAt(0) == 'E' && getText(param1Int, 1).charAt(0) != '-') {
                    arrayOfChar2[b1++] = c;
                }
            }
