...
public class Arrays {
    public static double[] append(double[] paramArrayOfdouble1, double[] paramArrayOfdouble2) {
        ...
        for (b = 0; b < i; ) {
            arrayOfDouble[b + j] = paramArrayOfdouble1[b];
            b++;
        }
    ...
    public static boolean isConstant(int[] paramArrayOfint) {
        ...
        for (byte b = 1; b < paramArrayOfint.length; ) {
            if (paramArrayOfint[b] != i) return false;
            b++;
        }
        return true;
    }
    ...
    public static boolean isConstant(double[] paramArrayOfdouble) {
        ...
        for (byte b = 1; b < paramArrayOfdouble.length; ) {
            if (paramArrayOfdouble[b] != d) return false;
            b++;
        }
        return true;
    }
    ...
    public static boolean isIntegers(double[] paramArrayOfdouble) {
        for (byte b = 0; b < paramArrayOfdouble.length; ) {
            if (Math.rint(paramArrayOfdouble[b]) != paramArrayOfdouble[b]) return false;
            b++;
        }
        return true;
    }
    ...
    public static double[] subtract(double[] paramArrayOfdouble1, double[] paramArrayOfdouble2) {
        ...
        double[] arrayOfDouble = new double[i];
        for (byte b = 0; b < i; ) {
            arrayOfDouble[b] = paramArrayOfdouble1[b] - paramArrayOfdouble2[b];
            b++;
        }
        return arrayOfDouble;
    }
