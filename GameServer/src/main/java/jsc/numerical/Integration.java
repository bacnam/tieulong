...
int j = (int)Math.min(paramInt, 2.0D * Math.pow(3.0D, 9.0D)); int k;
for (k = 1; k <= 8; ) { arrayOfInt[k] = 1; k++; }
...
double d1 = Math.abs(paramDouble - paramArrayOfdouble1[1]); byte b1;
for (b1 = 1; b1 <= paramInt; b1++) {
double d;
if ((d = Math.abs(paramDouble - paramArrayOfdouble1[b1])) < d1) { i = b1; d1 = d; }
...
double d6 = arrayOfDouble1[b1 + 1] - arrayOfDouble2[b1]; double d3;
if ((d3 = d4 - d5) == 0.0D)
...
try { arrayOfDouble2[b] = paramIntegratingFunction.getIntegral(paramFunction, paramDouble1, paramDouble2, b); }
catch (NumericalException numericalException) { return d; }
...
try { double d1 = Integration.clenshawCurtis(test50, test50.getA(), test50.getB(), d, 200);
System.out.println("F(" + b2 + ") CC = " + Maths.roundSigFigs(d1, b1) + " " + count + " "); }
catch (NumericalException numericalException) { System.out.println("F(" + b2 + ") CC " + numericalException.getMessage()); }

count = 0; 
try { double d1 = Integration.romberg(test50, test50.getA(), test50.getB(), d, 20);
System.out.println("F(" + b2 + ") R2 = " + Maths.roundSigFigs(d1, b1) + " " + count + " "); }
catch (NumericalException numericalException) { System.out.println("F(" + b2 + ") R2 " + numericalException.getMessage()); }
...
double p = 2.0D; double q = 4.0D;
Beta B = new Beta(this.p, this.q);
double b = 1.0D; double c = 2.0D;
PowerFunction PF = new PowerFunction(this.b, this.c); public Test50(int param2Int) {
this.i = param2Int; Integration.Test.count = 0;
} public double function(double param2Double) {
Integration.Test.count++;
switch (this.i) { case 0:
return Math.pow(param2Double, -5.0D);
case 1: return 1.0D;
case 2: return param2Double - 2.0D;
case 3: return param2Double * param2Double - 2.0D * param2Double + 3.0D;
case 4: return param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D;
case 5: return param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D;
case 6: return param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D;
case 7: return param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D;
case 8: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D;
case 9: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D;
case 10: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D;
case 11: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D;
case 12: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D) - 12.0D;
case 13: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D) - 12.0D) + 13.0D;
case 14: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D) - 12.0D) + 13.0D) - 14.0D;
...
case 16: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D) - 12.0D) + 13.0D) - 14.0D) + 15.0D) - 16.0D;
case 17: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D) - 12.0D) + 13.0D) - 14.0D) + 15.0D) - 16.0D) + 17.0D;
case 18: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D) - 12.0D) + 13.0D) - 14.0D) + 15.0D) - 16.0D) + 17.0D) - 18.0D;
case 19: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D) - 12.0D) + 13.0D) - 14.0D) + 15.0D) - 16.0D) + 17.0D) - 18.0D) + 19.0D;
case 20: return param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * (param2Double * param2Double * param2Double - 2.0D * param2Double * param2Double + 3.0D * param2Double - 4.0D) + 5.0D) - 6.0D) + 7.0D) - 8.0D) + 9.0D) - 10.0D) + 11.0D) - 12.0D) + 13.0D) - 14.0D) + 15.0D) - 16.0D) + 17.0D) - 18.0D) + 19.0D) - 20.0D;
case 21: return Math.exp(param2Double);
case 22: return Math.sin(Math.PI * param2Double);
case 23: return Math.cos(param2Double);
case 24: return param2Double / (Math.exp(param2Double) - 1.0D);
case 25: return 1.0D / (1.0D + param2Double * param2Double);
case 26: return 2.0D / (2.0D + Math.sin(31.41592653589793D * param2Double));
case 27: return 1.0D / (1.0D + param2Double * param2Double * param2Double * param2Double);
case 28: return 1.0D / (1.0D + Math.exp(param2Double));
case 29: return param2Double * Math.sin(30.0D * param2Double) * Math.cos(param2Double);
case 30: return param2Double * Math.sin(30.0D * param2Double) * Math.cos(50.0D * param2Double);
case 31: return param2Double * Math.sin(30.0D * param2Double) / Math.sqrt(1.0D - param2Double * param2Double / 39.47841760435743D);
case 32: return 0.46D * (Math.exp(param2Double) + Math.exp(-param2Double)) - Math.cos(param2Double);
case 33: return 1.0D / (param2Double * param2Double * param2Double * param2Double + param2Double * param2Double + 0.9D);
case 34: return Math.sqrt(98696.04401089359D - param2Double * param2Double) * Math.sin(param2Double);
case 35: return 1.0D / (1.0D + param2Double);
case 36: return Math.sqrt(param2Double);
case 37: return Math.pow(param2Double, 0.25D);
case 38: return Math.pow(param2Double, 0.125D);
case 39: return Math.pow(param2Double, 0.0625D);
case 40: return Math.sqrt(Math.abs(param2Double * param2Double - 0.25D));
case 41: return Math.pow(param2Double, 1.5D);
case 42: return Math.pow(Math.abs(param2Double * param2Double - 0.25D), 1.5D);
case 43: return Math.pow(param2Double, 2.5D);
case 44: return Math.pow(Math.abs(param2Double * param2Double - 0.25D), 2.5D);
case 46: if (param2Double >= 0.0D && param2Double <= 0.333D) return param2Double; 
...
case 47: if (param2Double > 0.49D && param2Double < 0.5D) return 0.0D; 
return -1000.0D * (param2Double * param2Double - param2Double);
case 48: if (param2Double >= 0.0D && param2Double <= 0.7182818284590451D) return 1.0D / (param2Double + 2.0D); 
if (param2Double > 0.7182818284590451D && param2Double <= 1.0D) return 0.0D; 
case 49: return 10000.0D * (param2Double - 0.1D) * (param2Double - 0.11D) * (param2Double - 0.12D) * (param2Double - 0.13D);
case 50: return Math.sin(314.1592653589793D * param2Double);
case 51: return Math.sqrt(1.0D - param2Double * param2Double);
case 52: return this.B.pdf(param2Double);
case 53: return param2Double * this.B.pdf(param2Double);
case 54: return this.PF.pdf(param2Double);
case 55: return param2Double * this.PF.pdf(param2Double); }
...
ChiSquared D = new ChiSquared(4.0D); public double function(double param2Double) {
return this.D.pdf(param2Double);
} }

static class Func4 implements Function {
Normal D = new Normal(1.0D, 1.0D); public double function(double param2Double) {
return this.D.pdf(param2Double);
}
}
}
