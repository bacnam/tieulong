...
public abstract class AbstractContinuousDistribution
    ...
    public double moment(int paramInt, double paramDouble) {
        ...
        try {
            return Integration.integrate(new MomentIntegrand(this, paramInt, paramDouble), this.minX, this.maxX, this.open, this.tolerance, 20);
        } catch (NumericalException numericalException) {
    ...
    static class Test {
        ...
        static class TestNormal
            ...
            TestNormal(double param2Double1, double param2Double2) {
                ...
                this.mean = param2Double1;
                this.sd = param2Double2;
            }
        ...
        static class TestBeta extends AbstractContinuousDistribution {
            ...
            TestBeta(double param2Double1, double param2Double2) {
                ...
                this.p = param2Double1;
                this.q = param2Double2;
                this.logB = Maths.lnB(param2Double1, param2Double2);
            }
    ...
    class CdfMinusP implements Function {
        private final AbstractContinuousDistribution this$0;
        double p;

        public CdfMinusP(AbstractContinuousDistribution this$0, double param1Double) {
            this.this$0 = this$0;
            this.p = param1Double;
        }
    ...
    class MeanIntegrand implements Function {
        ...
        MeanIntegrand(AbstractContinuousDistribution this$0) {
            this.this$0 = this$0;
        }
    ...
    class MomentIntegrand implements Function {
        private final AbstractContinuousDistribution this$0;
        int r;
        double a;
    ...
    class PDF implements Function {
        private final AbstractContinuousDistribution this$0;

        PDF(AbstractContinuousDistribution this$0) {
            this.this$0 = this$0;
        }
