...
for (byte b = 0; b < this.n; ) { arrayOfDouble[b] = this.rand.nextDouble(); b++; }
...
this.randomMethod = 1; this.n = (int)(paramDouble1 + paramDouble2 - 1.0D);
}
else if (paramDouble1 < 1.0D && paramDouble2 > 1.0D) {
this.randomMethod = 2; this.reverseOrder = false; tOpt(paramDouble1, paramDouble2);
} else if (paramDouble1 > 1.0D && paramDouble2 < 1.0D) {
this.randomMethod = 2; this.reverseOrder = true; tOpt(paramDouble2, paramDouble1);
} else if (paramDouble1 < 1.0D && paramDouble2 < 1.0D) {

this.randomMethod = 52;
this.pStar = paramDouble1; this.qStar = paramDouble2;
...
for (byte b = 0; b < i; ) { beta.random(); b++; }
