...
public class TwoSampleBootstrapMeansTest
    ...
    public TwoSampleBootstrapMeansTest(double[] paramArrayOfdouble1, double[] paramArrayOfdouble2, H1 paramH1, int paramInt, StatisticListener paramStatisticListener) {
        ...
        for (b = 0; b < this.nA; ) {
            ...
            d3 += paramArrayOfdouble1[b];
            b++;
        }
        d1 /= this.nA;
        for (b = 0; b < this.nB; ) {
            d2 += paramArrayOfdouble2[b];
            d3 += paramArrayOfdouble2[b];
            b++;
        }
        d2 /= this.nB;
        d3 /= this.N;
        ...
        for (b = 0; b < this.nA; ) {
            this.zA[b] = paramArrayOfdouble1[b] - d1 + d3;
            b++;
        }
        for (b = 0; b < this.nB; ) {
            this.zB[b] = paramArrayOfdouble2[b] - d2 + d3;
            b++;
        }
    ...
    protected double bootstrapSample() {
        byte b;
        for (b = 0; b < this.nA; ) {
            this.rA[b] = this.zA[this.rand.nextInt(this.nA)];
            b++;
        }
        for (b = 0; b < this.nB; ) {
            this.rB[b] = this.zB[this.rand.nextInt(this.nB)];
            b++;
        }
