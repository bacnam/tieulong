...
public class PitmanTwoSampleTest
    ...
    public PitmanTwoSampleTest(double[] paramArrayOfdouble1, double[] paramArrayOfdouble2, H1 paramH1) {
        ...
        if (Arrays.isIntegers(paramArrayOfdouble1) && Arrays.isIntegers(paramArrayOfdouble2)) {
            ...
            byte b;
            for (b = 0; b < i; ) {
                arrayOfInt1[b] = (int) paramArrayOfdouble1[b];
                arrayOfInt[b] = 1;
                b++;
            }
            for (b = 0; b < j; ) {
                arrayOfInt1[b + i] = (int) paramArrayOfdouble2[b];
                arrayOfInt[b + i] = 2;
                b++;
            }
            ...
            byte b;
            for (b = 0; b < i; ) {
                arrayOfDouble[b] = paramArrayOfdouble1[b];
                arrayOfInt[b] = 1;
                b++;
            }
            for (b = 0; b < j; ) {
                arrayOfDouble[b + i] = paramArrayOfdouble2[b];
                arrayOfInt[b + i] = 2;
                b++;
            }
    ...
    private double pitmanProb(double[] paramArrayOfdouble, int[] paramArrayOfint, int paramInt, double paramDouble) {
        ...
        for (b3 = 0; b3 < paramInt; ) {
            paramArrayOfdouble[b3] = paramArrayOfdouble[b3] - d8;
            b3++;
        }
        ...
        if (bool2 != bool1) {
            ...
            for (b3 = 0; b3 < paramInt; ) {
                paramArrayOfdouble[b3] = d9 - paramArrayOfdouble[b3];
                b3++;
            }
            d1 = b1 * d9 - d1;
            d2 = b2 * d9 - d2;
        ...
        for (d12 = 0.0D, d13 = 0.0D, b3 = 0; b3 < paramInt; b3++) {
            ...
            for (int n = b3 + 1; n < paramInt; ) {
                d13 -= 2.0D * paramArrayOfdouble[b3] * paramArrayOfdouble[n] / (d15 - 1.0D);
                n++;
            }
        ...
        if ((this.alternative == H1.LESS_THAN && bool2 == true) || (this.alternative == H1.GREATER_THAN && bool2 == 2)) {
            ...
            for (b3 = 0; b3 <= i; ) {
                d5 += arrayOfDouble[arrayOfInt1[b5 - 1] + b3];
                b3++;
            }
    ...
    private double pitmanProbInt(int[] paramArrayOfint1, int[] paramArrayOfint2, int paramInt) {
        ...
        for (b3 = 0; b3 < paramInt; ) {
            paramArrayOfint1[b3] = paramArrayOfint1[b3] - i;
            b3++;
        }
        ...
        if (bool1 != bool2) {
            ...
            for (b3 = 0; b3 < paramInt; ) {
                paramArrayOfint1[b3] = j - paramArrayOfint1[b3];
                b3++;
            }
            m = b1 * j - m;
            n = b2 * j - n;
        ...
        if ((this.alternative == H1.LESS_THAN && bool1 == true) || (this.alternative == H1.GREATER_THAN && bool1 == 2)) {
            ...
            for (b3 = 0; b3 <= i1; ) {
                d3 += arrayOfDouble[arrayOfInt[b5 - 1] + b3];
                b3++;
            }
