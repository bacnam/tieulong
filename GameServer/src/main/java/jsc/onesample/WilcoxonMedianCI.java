...
public class WilcoxonMedianCI
    ...
    public WilcoxonMedianCI(double[] paramArrayOfdouble, double paramDouble, boolean paramBoolean) {
        ...
        if (paramBoolean) {
            ...
            while (l < wilcoxonT.getMaxValue() && d1 < d) {
                l++;
                d1 += wilcoxonT.pdf(l);
            }
            l--;
        ...
        while (true) {
            ...
            while (true) {
                if (!bool) {
                    ...
                    for (b = 1; b <= i; b++) {
                        ...
                        if (i6 <= arrayOfInt2[b] - arrayOfInt1[b])
                            break;
                        i6 = i6 - arrayOfInt2[b] + arrayOfInt1[b] - 1;
                    }
                ...
                if (k - n < 0) {
                    ...
                    for (b = 1; b <= i; ) {
                        arrayOfInt2[b] = b + arrayOfInt3[b] - 1;
                        b++;
                    }
                }
    ...
    static class Test {
        public static void main(String[] param1ArrayOfString) {
            ...
            byte b;
            for (b = 0; b < i; ) {
                arrayOfDouble1[b] = normal.random();
                b++;
            }
