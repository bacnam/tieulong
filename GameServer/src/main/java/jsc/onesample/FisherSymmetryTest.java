    ...
    private double fisherProb(double[] paramArrayOfdouble, double paramDouble) {
        ...
        for (byte b5 = 1; b5 < i; b5++) {
            ...
            if (i1 > j) {
                ...
                for (int i4 = j; i4 >= j - arrayOfInt[b5] + 1; ) {
                    arrayOfDouble[j + 1] = arrayOfDouble[j + 1] + arrayOfDouble[i4];
                    i4--;
                }

            }
            int i3 = (j > i1) ? i1 : j;
            for (int i2 = i3; i2 >= arrayOfInt[b5]; ) {
                arrayOfDouble[i2] = arrayOfDouble[i2] + arrayOfDouble[i2 - arrayOfInt[b5]];
                i2--;
            }
            n = i1;
        }
    ...
    private double fisherProbInt(double[] paramArrayOfdouble) {
        ...
        for (byte b1 = 1; b1 < i; b1++) {
            ...
            if (i2 > k) {
                ...
                for (int i5 = k; i5 >= k - paramArrayOfdouble[b1] + 1.0D; ) {
                    arrayOfDouble[k + 1] = arrayOfDouble[k + 1] + arrayOfDouble[i5];
                    i5--;
                }

            }
            int i4 = (k > i2) ? i2 : k;
            for (int i3 = i4; i3 >= paramArrayOfdouble[b1]; ) {
                arrayOfDouble[i3] = arrayOfDouble[i3] + arrayOfDouble[i3 - (int) paramArrayOfdouble[b1]];
                i3--;
            }
            j = i2;
        }
