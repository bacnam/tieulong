...
public class MatchedData
    ...
    public MatchedData(double[][] paramArrayOfdouble, String[] paramArrayOfString1, String[] paramArrayOfString2) {
        ...
        for (b = 0; b < this.blockCount; ) {
            this.blockLabels.add(paramArrayOfString1[b]);
            b++;
        }
        for (b = 0; b < this.treatmentCount; ) {
            this.treatmentLabels.add(paramArrayOfString2[b]);
            b++;
        }
    ...
    public MatchedData copy() {
        ...
        byte b;
        for (b = 0; b < this.blockCount; ) {
            arrayOfString1[b] = this.blockLabels.get(b);
            b++;
        }
        for (b = 0; b < this.treatmentCount; ) {
            arrayOfString2[b] = this.treatmentLabels.get(b);
            b++;
        }
        for (b = 0; b < this.blockCount; b++) {
    ...
    public double getBlockMean(int paramInt) {
        double d = 0.0D;
        for (byte b = 0; b < this.treatmentCount; ) {
            d += this.data[paramInt][b];
            b++;
        }
    ...
    public double[] getTreatmentData(int paramInt) {
        ...
        for (byte b = 0; b < this.blockCount; ) {
            arrayOfDouble[b] = this.data[b][paramInt];
            b++;
        }
        return arrayOfDouble;
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("\nMatched data\n");
        byte b1;
        for (b1 = 0; b1 < this.treatmentCount; ) {
            stringBuffer.append("\t" + getTreatmentLabel(b1));
            b1++;
        }
        for (byte b2 = 0; b2 < this.blockCount; b2++) {
            ...
            stringBuffer.append("\n" + getBlockLabel(b2));
            for (b1 = 0; b1 < this.treatmentCount; ) {
                stringBuffer.append("\t" + this.data[b2][b1]);
                b1++;
            }
