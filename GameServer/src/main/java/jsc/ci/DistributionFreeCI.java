...
public class DistributionFreeCI
    ...
    protected void computeInterval(int paramInt1, int paramInt2, double[] paramArrayOfdouble1, double[] paramArrayOfdouble2) {
        ...
        byte b;
        for (b = 1; b <= k; ) {
            arrayOfDouble1[b] = paramArrayOfdouble1[b - 1];
            b++;
        }
        ...
        if (paramInt1 == 0 || paramInt1 == 1) {
            ...
            if (paramInt1 == 1) {
                ...
                m = j;
                for (b = 1; b <= m; ) {
                    arrayOfDouble2[b] = paramArrayOfdouble2[b - 1];
                    b++;
                }
                for (b = 1; b <= k; ) {
                    arrayOfDouble1[b] = arrayOfDouble1[b] - arrayOfDouble2[b];
                    b++;
                }
            ...
            for (b = 1; b <= k; ) {
                arrayOfDouble2[b] = -arrayOfDouble1[b];
                b++;
            }
            ...
            if (paramInt1 == 3) {
                ...
                for (b = 1; b <= k; ) {
                    arrayOfDouble1[b] = Math.log(arrayOfDouble1[b]);
                    b++;
                }
                for (b = 1; b <= m; ) {
                    arrayOfDouble2[b] = Math.log(arrayOfDouble2[b]);
                    b++;
                }
    ...
    private Double[] diff(int paramInt1, int paramInt2, int paramInt3, double[] paramArrayOfdouble1, int paramInt4, double[] paramArrayOfdouble2, int paramInt5, int[] paramArrayOfint) {
        ...
        if (paramInt1 == 0 || paramInt1 == 1) {
            for (byte b = 1; b <= paramInt3; ) {
                paramArrayOfint[b] = b;
                b++;
            }
        } else {
            for (byte b = 1; b <= paramInt4; ) {
                paramArrayOfint[b] = 1;
                b++;
            }
        }
    ...
    static class Test {
        public static void main(String[] param1ArrayOfString) {
            ...
            System.out.print("\nWalsh averages: ");
            byte b;
            for (b = 0; b < arrayOfDouble2.length; ) {
                System.out.print(arrayOfDouble2[b] + ",");
                b++;
            }
            ...
            System.out.print("\nDifferences: ");
            for (b = 0; b < arrayOfDouble5.length; ) {
                System.out.print(arrayOfDouble5[b] + ",");
                b++;
            }
