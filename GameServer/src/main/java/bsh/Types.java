...
class Types {
    ...
    static boolean isJavaBaseAssignable(Class<?> lhsType, Class<?> rhsType) {
        ...
        if (lhsType.isPrimitive() && rhsType.isPrimitive()) {
            ...
            if (rhsType == byte.class && (lhsType == short.class || lhsType == int.class || lhsType == long.class
                    || lhsType == float.class || lhsType == double.class)) {

                return true;
            }
            if (rhsType == short.class && (lhsType == int.class || lhsType == long.class || lhsType == float.class
                    || lhsType == double.class)) {

                return true;
            }
            if (rhsType == char.class && (lhsType == int.class || lhsType == long.class || lhsType == float.class
                    || lhsType == double.class)) {
        ...
        if (fromType == void.class || fromType == null || fromType.isPrimitive()) {
            ...
            if (Primitive.isWrapperType(toType) && fromType != void.class && fromType != null) {
                ...
                return checkOnly ? VALID_CAST
                        : Primitive.castWrapper(Primitive.unboxType(toType), ((Primitive) fromValue).getValue());
            }
