...
public class ClassBrowser
    ...
    public void init() throws ClassPathException {
        ...
        JSplitPane methodConsPane = splitPane(0, true, labeledPane(new JScrollPane(this.conslist), "Constructors"),
                labeledPane(new JScrollPane(this.mlist), "Methods"));

        JSplitPane rightPane = splitPane(0, true, methodConsPane,
                labeledPane(new JScrollPane(this.fieldlist), "Fields"));
    ...
    public void valueChanged(ListSelectionEvent e) {
        if (e.getSource() == this.classlist) {
            ...
            if (classname == null) {
                ...
                String fullClassName = this.selectedPackage.equals("<unpackaged>") ? classname
