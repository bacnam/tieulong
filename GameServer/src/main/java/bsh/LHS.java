...
class LHS
        ...
        if (this.type == 0) {
            ...
            if (this.type == 1) {
                ...
                try {
                    ...
                    String type = (val instanceof Primitive) ? ((Primitive) val).getType().getName()
                            : val.getClass().getName();

                    throw new UtilEvalError("Argument type mismatch. " + ((val == null) ? "null" : type)
    ...
    public String toString() {
        return "LHS: " + ((this.field != null) ? ("field = " + this.field.toString()) : "")
                + ((this.varName != null) ? (" varName = " + this.varName) : "")
                + ((this.nameSpace != null) ? (" nameSpace = " + this.nameSpace.toString()) : "");
    }
}
