...
this.majorVersion = Integer.parseInt(((String)versionParts.get(0)).toString());

if (versionParts.size() > 1) {
this.minorVersion = Integer.parseInt(((String)versionParts.get(1)).toString());
} else {
this.minorVersion = 0;
} 

if (versionParts.size() > 2) {
this.subminorVersion = Integer.parseInt(((String)versionParts.get(2)).toString());
} else {
