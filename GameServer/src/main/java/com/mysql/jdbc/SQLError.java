...
private static Map<String, String> sqlStateMessages = new HashMap<String, String>(); static {
...
currentWarning = newTruncation; continue;
} 
...
if (currentWarning == null) {
currentWarning = newWarning; continue;
} 
