...
import java.io.InputStream;
    public static final int PORT_NUMBER_INDEX = 1;ic finva.sql.Connection;
    public static final String PROTOCOLalriverPropertyInfo;
    public static final String USE_CONFIG_PROPERT String PORT_PROPERTY_KEY = "PORT";ertiesTransform";onfigs";g PASSWORD_PROPERTgDriver
      tatic final String ord";
ConcurrentHashMap;

public class NonRegisterinublic static final String NUM_HOSTS_PROPERTY_KEY = "NUM_HOSTS";

    publicHOST_PROPERTY_KEY = "HOST";

    pY_KEY = "passw ean TRACE = false;er";_PROPERTY_KEY = "PROTOCOL";Y_KEY = "useCsic static final String USER_PROPERTY_KEY = "ustatic final Str
  implements Driver {
...
AME_PROPERTY_KEY = "DBNAME";

    public static final boo
    private static final String URL_PREFIX = "jdbc:mysql:
nceQueue<ConnectionImpl>();
    ...
    protected static final ReferenceQueue<ConnectionImpl> refQueue = new Refere
