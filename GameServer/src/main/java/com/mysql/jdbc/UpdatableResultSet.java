...
String str1 = this.fields[i].getDatabaseName();

if (str1 != null && str1.length() > 0) {
tableNameBuffer.append(quotedId);
tableNameBuffer.append(str1);
tableNameBuffer.append(quotedId);
...
setParamValue(this.updater, numFields + j + 1, this.thisRow, idx, this.fields[idx].getSQLType());
} 
} 
}
