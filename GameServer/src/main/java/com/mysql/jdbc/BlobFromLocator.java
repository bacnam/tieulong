    ...
    class LocatorInputStream extends InputStream {
        ...
        LocatorInputStream(long pos, long len) throws SQLException {
            ...
            if (pos + len > blobLength) {
                throw SQLError.createSQLException(Messages.getString("Blob.invalidStreamLength", new Object[]{Long.valueOf(blobLength), Long.valueOf(pos), Long.valueOf(len)}), "S1009", BlobFromLocator.this.exceptionInterceptor);
            }
