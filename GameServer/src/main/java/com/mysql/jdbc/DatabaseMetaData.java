...
public class DatabaseMetaData
    ...
    static {
        ...
        if (it.hasNext()) {
            keywordBuf.append(((String) it.next()).toString());
        }
    ...
    public ResultSet extractForeignKeyFromCreateTable(String catalog, String tableName) throws SQLException {
        ...
        fields[0] = new Field("", "Name", 1, 2147483647);
        fields[1] = new Field("", "Type", 1, 255);
        fields[2] = new Field("", "Comment", 1, 2147483647);
...
return results;
            ...
            protected Field[] createColumnsFields () {
                ...
                fields[6] = new Field("", "COLUMN_SIZE", 4, Integer.toString(2147483647).length());
                ...
                fields[15] = new Field("", "CHAR_OCTET_LENGTH", 4, Integer.toString(2147483647).length());
                                            ...
                                            if (comment != null) {
                                                ...
                                                while (commentTokens.hasMoreTokens()) {
                                                    ...
                                                    while (referencingColumns.hasNext()) {
                                                        String referencingColumn = DatabaseMetaData.this.removeQuotedId(referencingColumns.next());
                                                        ...
                                                        tuple[3] = DatabaseMetaData.this.s2b(DatabaseMetaData.this.removeQuotedId(referencedColumns.next()));
            ...
            public String getDriverVersion () throws SQLException {
                return "mysql-connector-java-5.1.23 ( Revision: ${bzr.revision-id} )";
            }
            ...
            protected void getExportKeyResults (String catalog, String exportingTable, String
            keysComment, List < ResultSetRow > tuples, String fkTableName) throws SQLException {
            ...
            protected void getImportKeyResults (String catalog, String importingTable, String
            keysComment, List < ResultSetRow > tuples) throws SQLException {
                getResultsImpl(catalog, importingTable, keysComment, tuples, null, false);
            }

            public ResultSet getIndexInfo (String catalog, String schema,final String table, final boolean unique,
                    ...
                    (new IterateBlock<String>(getCatalogIterator(catalog)) {
                        void forEach(String catalogStr) throws SQLException {
                            ...
                            try {
                                ...
                                TreeMap<String, byte[][]> sortMap = (TreeMap) new TreeMap<String, byte>();
            ...
            protected ResultSet getProcedureOrFunctionColumns (Field[]fields, String catalog, String
            schemaPattern, String procedureOrFunctionNamePattern, String columnNamePattern,boolean returnProcedures,
            ...
            public ResultSet getProcedures (String catalog, String schemaPattern, String procedureNamePattern) throws
            SQLException {
            ...
            protected ResultSet getProceduresAndOrFunctions ( final Field[] fields, String catalog, String
            schemaPattern, String procedureNamePattern,final boolean returnProcedures, final boolean returnFunctions) throws
            SQLException {
                    ...
                    (new IterateBlock<String>(getCatalogIterator(catalog)) {
                        void forEach(String catalogStr) throws SQLException {
                            ...
                            try {
                                ...
                                Iterator<ResultSetRow> proceduresIter = procedureRowsOrderedByName.values().iterator();
            ...
            private void getResultsImpl (String catalog, String table, String
            keysComment, List < ResultSetRow > tuples, String fkTableName,boolean isExport) throws SQLException {
            ...
            public ResultSet getTablePrivileges (String catalog, String schemaPattern, String tableNamePattern) throws
            SQLException {
                        ...
                        void forEach(String catalogStr) throws SQLException {
                            ...
                            try {
                                if (!DatabaseMetaData.this.conn.versionMeetsMinimum(5, 0, 2)) {
                                    try {
                                        results = stmt.executeQuery("SHOW TABLES FROM " + DatabaseMetaData.this.quotedId + catalogStr + DatabaseMetaData.this.quotedId + " LIKE '" + tableNamePat + "'");
                                    ...
                                    try {
                                        results = stmt.executeQuery("SHOW FULL TABLES FROM " + DatabaseMetaData.this.quotedId + catalogStr + DatabaseMetaData.this.quotedId + " LIKE '" + tableNamePat + "'");
                                ...
                                while (results.next()) {
                                    ...
                                    if (hasTableTypes) {
                                        ...
                                        if (("table".equalsIgnoreCase(tableType) || "base table".equalsIgnoreCase(tableType)) && shouldReportTables) {
                                            ...
                                            if (reportTable) {
                                                if (tablesOrderedByName == null) {
                                                    tablesOrderedByName = (TreeMap) new TreeMap<String, byte>();
                                                }
                                        ...
                                        if ("system view".equalsIgnoreCase(tableType) && shouldReportSystemTables) {
                                            row[3] = DatabaseMetaData.SYSTEM_TABLE_AS_BYTES;
                                        ...
                                        if ("view".equalsIgnoreCase(tableType) && shouldReportViews) {
                                            ...
                                            if (viewsOrderedByName == null) {
                                                viewsOrderedByName = (TreeMap) new TreeMap<String, byte>();
                                            }
                                ...
                                if (tablesOrderedByName != null) {
                                    Iterator<byte[][]> tablesIter = (Iterator) tablesOrderedByName.values().iterator();
                                ...
                                if (viewsOrderedByName != null) {
                                    Iterator<byte[][]> viewsIter = (Iterator) viewsOrderedByName.values().iterator();
            ...
            public ResultSet getTypeInfo () throws SQLException {
                ...
                rowVal[2] = Integer.toString(2147483647).getBytes();
            ...
            public ResultSet getUDTs (String catalog, String schemaPattern, String typeNamePattern,int[] types) throws
            SQLException {
                Field[] fields = new Field[6];
                        ...
                        void forEach(String catalogStr) throws SQLException {
                            ...
                            try {
                                ...
                                if (!DatabaseMetaData.this.conn.versionMeetsMinimum(5, 1, 23)) {
                                    ...
                                    String query = "SHOW CREATE TABLE " + DatabaseMetaData.this.quotedId + catalogStr + DatabaseMetaData.this.quotedId + "." + DatabaseMetaData.this.quotedId + table + DatabaseMetaData.this.quotedId;
            ...
            protected LocalAndReferencedColumns parseTableStatusIntoLocalAndReferencedColumns (String keysComment) throws
            SQLException {
                String columnsDelimitter = ",";

                char quoteChar = (this.quotedId.length() == 0) ? Character.MIN_VALUE : this.quotedId.charAt(0);
            ...
            public ResultSet getPseudoColumns (String catalog, String schemaPattern, String tableNamePattern, String
