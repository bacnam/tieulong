...
break label34;
case '}':
break label34; }  }  if (i < this.buffer.length) {
if (fillBuffer(i + 1)) {
continue;
}
...
int c = 0; while (true) { if (c < toFind.length()) {
