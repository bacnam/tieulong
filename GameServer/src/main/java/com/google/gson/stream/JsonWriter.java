...
{
private static final String[] REPLACEMENT_CHARS = new String[128]; static {
for (int i = 0; i <= 31; i++) {
...
} private static final String[] HTML_SAFE_REPLACEMENT_CHARS = (String[])REPLACEMENT_CHARS.clone(); static {
...
private int stackSize = 0; private String indent;
...
String replacement; char c = value.charAt(i);
