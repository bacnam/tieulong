...
public class FacebookService {
    ...
    public static class Processor
        ...
        public Processor(FacebookService.Iface iface) {
            ...
            this.iface_ = iface;
            this.processMap_.put("getName", new getName());
            this.processMap_.put("getVersion", new getVersion());
            this.processMap_.put("getStatus", new getStatus());
            this.processMap_.put("getStatusDetails", new getStatusDetails());
            this.processMap_.put("getCounters", new getCounters());
            this.processMap_.put("getCounter", new getCounter());
            this.processMap_.put("setOption", new setOption());
            this.processMap_.put("getOption", new getOption());
            this.processMap_.put("getOptions", new getOptions());
            ...
            this.processMap_.put("shutdown", new shutdown());
        }
