    ...
    public static void attemptClose(Socket paramSocket, RobustMessageLogger paramRobustMessageLogger) {
        try {
            ...
            if (paramRobustMessageLogger != null)
                paramRobustMessageLogger.log(iOException, "IOException trying to close Socket");
        } catch (NullPointerException nullPointerException) {
            if (paramRobustMessageLogger != null)
                paramRobustMessageLogger.log(nullPointerException, "NullPointerException trying to close Socket");
        }
    }
}
