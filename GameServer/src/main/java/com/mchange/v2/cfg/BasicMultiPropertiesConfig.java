...
HashMap<Object, Object> hashMap = new HashMap<Object, Object>();
ArrayList<String> arrayList = new ArrayList(); byte b;
int i;
...
Properties properties = new Properties(); byte b; int i;
for (b = 0, i = paramArrayOfString.length; b < i; b++) {
...
HashMap<Object, Object> hashMap = new HashMap<Object, Object>(); byte b;
int i;
for (b = 0, i = paramArrayOfString.length; b < i; b++) {
