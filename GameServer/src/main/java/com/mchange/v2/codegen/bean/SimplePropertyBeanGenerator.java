...
this.propertyTypes = new Class[this.props.length]; byte b; int i;
...
this.iw.println("this.iw.println(" * This class autogenerated by " + this.generatorName + '.');
...
this.iw.println("this.iw.println(" * This class was generated by " + this.generatorName + ".");
this.iw.println(" */");
}
