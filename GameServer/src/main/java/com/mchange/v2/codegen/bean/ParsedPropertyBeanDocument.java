...
int i = 0;
String[] arrayOfString = DomParseUtils.allTextFromImmediateChildElements(paramElement, "modifier", true); byte b; int j;
for (b = 0, j = arrayOfString.length; b < j; b++) {

String str = arrayOfString[b];
if ("public".equals(str)) { i |= 0x1; }
else if ("protected".equals(str)) { i |= 0x4; }
else if ("private".equals(str)) { i |= 0x2; }
else if ("final".equals(str)) { i |= 0x10; }
else if ("abstract".equals(str)) { i |= 0x400; }
else if ("static".equals(str)) { i |= 0x8; }
else if ("synchronized".equals(str)) { i |= 0x20; }
else if ("volatile".equals(str)) { i |= 0x40; }
else if ("transient".equals(str)) { i |= 0x80; }
else if ("strictfp".equals(str)) { i |= 0x800; }
else if ("native".equals(str)) { i |= 0x100; }
else if ("interface".equals(str)) { i |= 0x200; }
else { throw new IllegalArgumentException("Bad modifier: " + str); }
