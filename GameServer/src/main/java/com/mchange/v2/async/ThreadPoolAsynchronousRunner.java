...
return;  this.deadlockDetector.cancel();
...
IndentedWriter indentedWriter = new IndentedWriter(stringWriter); byte b;
...
paramIndentedWriter.upIndent(); byte b; int i;
...
indentedWriter.upIndent(); byte b1; int i;
...
paramStringBuffer.append("; pendingTasks: "); byte b; int i;
