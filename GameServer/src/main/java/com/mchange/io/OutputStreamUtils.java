    ...
    public static void attemptClose(OutputStream paramOutputStream, RobustMessageLogger paramRobustMessageLogger) {
        try {
            ...
            if (paramRobustMessageLogger != null)
                paramRobustMessageLogger.log(iOException, "IOException trying to close OutputStream");
        } catch (NullPointerException nullPointerException) {
            if (paramRobustMessageLogger != null)
                paramRobustMessageLogger.log(nullPointerException, "NullPointerException trying to close OutputStream");
        }
    }
}
