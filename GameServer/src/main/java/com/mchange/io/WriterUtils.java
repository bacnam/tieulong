    ...
    public static void attemptClose(Writer paramWriter, RobustMessageLogger paramRobustMessageLogger) {
        try {
            ...
            if (paramRobustMessageLogger != null)
                paramRobustMessageLogger.log(iOException, "IOException trying to close Writer");
        } catch (NullPointerException nullPointerException) {
            if (paramRobustMessageLogger != null)
                paramRobustMessageLogger.log(nullPointerException, "NullPointerException trying to close Writer");
        }
    }
}
