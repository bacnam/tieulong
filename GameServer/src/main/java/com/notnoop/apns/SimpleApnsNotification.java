...
this.marshall = null; this.deviceToken = Utilities.decodeHex(dtoken); this.payload = Utilities.toUTF8Bytes(payload); } public SimpleApnsNotification(byte[] dtoken, byte[] payload) { this.marshall = null;
