...
public class SSLServerIOEventDispatch
    ...
    protected NHttpServerIOTarget createConnection(IOSession session) {
        return new DefaultNHttpServerConnection(session, createHttpRequestFactory(), createByteBufferAllocator(), this.params);
    }
    ...
    public void connected(IOSession session) {
        ...
        NHttpServerIOTarget conn = createConnection((IOSession) sslSession);
