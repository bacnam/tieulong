...
if (handler != null) {
return new BufferingHttpServiceHandler.RequestHandlerAdaptor(handler);
}
return null;
}
}
...
return (ConsumingNHttpEntity)new BufferingNHttpEntity(request.getEntity(), (ByteBufferAllocator)HeapByteBufferAllocator.INSTANCE);
}
