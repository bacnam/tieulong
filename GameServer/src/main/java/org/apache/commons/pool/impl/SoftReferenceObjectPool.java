...
this._numActive = 0; this._pool = new ArrayList(); this._factory = null; } public SoftReferenceObjectPool(PoolableObjectFactory factory) { this._pool = null; this._factory = null; this.refQueue = new ReferenceQueue(); this._numActive = 0; this._pool = new ArrayList(); this._factory = factory; } public SoftReferenceObjectPool(PoolableObjectFactory factory, int initSize) throws Exception, IllegalArgumentException { this._pool = null; this._factory = null; this.refQueue = new ReferenceQueue(); this._numActive = 0;
if (factory == null)
