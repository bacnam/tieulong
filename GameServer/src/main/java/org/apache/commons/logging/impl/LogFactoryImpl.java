...
return AccessController.<String>doPrivileged(new PrivilegedAction(key, def) { private final String val$key;
...
try {
return AccessController.<ClassLoader>doPrivileged(new PrivilegedAction(this, cl) { private final ClassLoader val$cl;
