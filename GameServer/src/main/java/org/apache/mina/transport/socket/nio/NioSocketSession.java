...
extends NioSession
{
static final TransportMetadata METADATA = (TransportMetadata)new DefaultTransportMetadata("nio", "socket", false, true, InetSocketAddress.class, SocketSessionConfig.class, new Class[] { IoBuffer.class, FileRegion.class });
...
this.config = (IoSessionConfig)new SessionConfigImpl();
...
if (sslFilter != null)
{
return ((SslFilter)sslFilter).isSslStarted((IoSession)this);
}
return false;
}
}
