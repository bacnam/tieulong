...
try { NioDatagramAcceptor.this.lock.acquire();
...
NioDatagramAcceptor.this.lock.release(); break; }  } finally { NioDatagramAcceptor.this.lock.release(); }
...
scheduleFlush(session); continue;
} 
setInterestedInWrite(session, false);
